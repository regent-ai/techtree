...
// ../monorepo/platform/node_modules/abitype/dist/esm/version.js
var version;
...
// ../monorepo/platform/node_modules/abitype/dist/esm/errors.js
var BaseError;
...
// ../monorepo/platform/node_modules/abitype/dist/esm/regex.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/formatAbiParameter.js
function formatAbiParameter(abiParameter) {
  ...
  if (tupleRegex.test(abiParameter.type) && "components" in abiParameter) {
    ...
    for (let i21 = 0; i21 < length; i21++) {
      const component = abiParameter.components[i21];
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/formatAbiParameters.js
function formatAbiParameters(abiParameters) {
  let params = "";
  const length = abiParameters.length;
  for (let i21 = 0; i21 < length; i21++) {
    const abiParameter = abiParameters[i21];
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/formatAbiItem.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/runtime/signatures.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/errors/abiItem.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/errors/abiParameter.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/errors/signature.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/errors/struct.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/errors/splitParameters.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/runtime/cache.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/runtime/utils.js
...
function parseFunctionSignature(signature, structs = {}) {
  ...
  for (let i21 = 0; i21 < inputLength; i21++) {
    inputs.push(parseAbiParameter(inputParams[i21], {
  ...
  if (match.returns) {
    ...
    for (let i21 = 0; i21 < outputLength; i21++) {
      outputs.push(parseAbiParameter(outputParams[i21], {
        modifiers: functionModifiers,
        structs,
        type: "function"
      }));
...
function parseEventSignature(signature, structs = {}) {
  ...
  for (let i21 = 0; i21 < length; i21++)
    abiParameters.push(parseAbiParameter(params[i21], {
...
function parseErrorSignature(signature, structs = {}) {
  ...
  const length = params.length;
  for (let i21 = 0; i21 < length; i21++)
    abiParameters.push(parseAbiParameter(params[i21], { structs, type: "error" }));
...
function parseConstructorSignature(signature, structs = {}) {
  ...
  const length = params.length;
  for (let i21 = 0; i21 < length; i21++)
    abiParameters.push(parseAbiParameter(params[i21], { structs, type: "constructor" }));
  return {
    type: "constructor",
    stateMutability: match.stateMutability ?? "nonpayable",
...
function parseAbiParameter(param, options) {
  ...
  if (isTuple) {
    ...
    const length = params.length;
    for (let i21 = 0; i21 < length; i21++) {
      components_.push(parseAbiParameter(params[i21], { structs }));
    }
...
function splitParameters(params, result = [], current = "", depth = 0) {
  ...
  for (let i21 = 0; i21 < length; i21++) {
    const char = params[i21];
    const tail = params.slice(i21 + 1);
    switch (char) {
      case ",":
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/runtime/structs.js
function parseStructs(signatures) {
  const shallowStructs = {};
  const signaturesLength = signatures.length;
  for (let i21 = 0; i21 < signaturesLength; i21++) {
    const signature = signatures[i21];
  ...
  for (let i21 = 0; i21 < entriesLength; i21++) {
    const [name, parameters] = entries[i21];
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/parseAbi.js
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/parseAbiItem.js
function parseAbiItem(signature) {
  ...
  if (typeof signature === "string")
    ...
    for (let i21 = 0; i21 < length; i21++) {
      const signature_ = signature[i21];
...
// ../monorepo/platform/node_modules/abitype/dist/esm/human-readable/parseAbiParameters.js
function parseAbiParameters(params) {
  ...
  if (typeof params === "string") {
    ...
    for (let i21 = 0; i21 < length; i21++) {
      abiParameters.push(parseAbiParameter(parameters[i21], { modifiers }));
    }
  } else {
    const structs = parseStructs(params);
    const length = params.length;
    for (let i21 = 0; i21 < length; i21++) {
      const signature = params[i21];
      if (isStructSignature(signature))
        continue;
...
// ../monorepo/platform/node_modules/abitype/dist/esm/exports/index.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/formatAbiItem.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/data/isHex.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/data/size.js
function size(value) {
...
// ../monorepo/platform/node_modules/viem/_esm/errors/version.js
var version2;
...
// ../monorepo/platform/node_modules/viem/_esm/errors/base.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/abi.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/data.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/data/pad.js
...
function padBytes(bytes, { dir, size: size5 = 32 } = {}) {
  ...
  for (let i21 = 0; i21 < size5; i21++) {
    const padEnd = dir === "right";
    paddedBytes[padEnd ? i21 : size5 - i21 - 1] = bytes[padEnd ? i21 : bytes.length - i21 - 1];
  }
  return paddedBytes;
}
var init_pad = __esm({
...
// ../monorepo/platform/node_modules/viem/_esm/errors/encoding.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/data/trim.js
function trim(hexOrBytes, { dir = "left" } = {}) {
  let data = typeof hexOrBytes === "string" ? hexOrBytes.replace("0x", "") : hexOrBytes;
  let sliceLength = 0;
  for (let i21 = 0; i21 < data.length - 1; i21++) {
    if (data[dir === "left" ? i21 : data.length - i21 - 1].toString() === "0")
      sliceLength++;
    else
      break;
  }
...
// ../monorepo/platform/node_modules/viem/_esm/utils/encoding/fromHex.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/encoding/toHex.js
...
var init_toHex = __esm({
  "../monorepo/platform/node_modules/viem/_esm/utils/encoding/toHex.js"() {
    ...
    init_pad();
    init_fromHex();
    hexes = /* @__PURE__ */ Array.from({ length: 256 }, (_v, i21) => i21.toString(16).padStart(2, "0"));
    encoder2 = /* @__PURE__ */ new TextEncoder();
  }
});

// ../monorepo/platform/node_modules/viem/_esm/utils/encoding/toBytes.js
...
// ../monorepo/platform/node_modules/@noble/hashes/esm/_u64.js
...
function split(lst, le = false) {
  ...
  for (let i21 = 0; i21 < len; i21++) {
    const { h: h10, l: l8 } = fromBig(lst[i21], le);
    [Ah[i21], Al[i21]] = [h10, l8];
  }
  return [Ah, Al];
}
...
var init_u64 = __esm({
  "../monorepo/platform/node_modules/@noble/hashes/esm/_u64.js"() {
    ...
    rotlSH = (h10, l8, s11) => h10 << s11 | l8 >>> 32 - s11;
    rotlSL = (h10, l8, s11) => l8 << s11 | h10 >>> 32 - s11;
    rotlBH = (h10, l8, s11) => l8 << s11 - 32 | h10 >>> 64 - s11;
    rotlBL = (h10, l8, s11) => h10 << s11 - 32 | l8 >>> 64 - s11;
  }
});

// ../monorepo/platform/node_modules/@noble/hashes/esm/crypto.js
var crypto2;
...
// ../monorepo/platform/node_modules/@noble/hashes/esm/utils.js
...
function anumber(n8) {
  if (!Number.isSafeInteger(n8) || n8 < 0)
    throw new Error("positive integer expected, got " + n8);
}
...
function clean(...arrays) {
  for (let i21 = 0; i21 < arrays.length; i21++) {
    arrays[i21].fill(0);
  }
}
...
function concatBytes(...arrays) {
  let sum = 0;
  for (let i21 = 0; i21 < arrays.length; i21++) {
    const a20 = arrays[i21];
    abytes(a20);
    sum += a20.length;
  }
  const res = new Uint8Array(sum);
  for (let i21 = 0, pad4 = 0; i21 < arrays.length; i21++) {
    const a20 = arrays[i21];
    res.set(a20, pad4);
    pad4 += a20.length;
  }
...
// ../monorepo/platform/node_modules/@noble/hashes/esm/sha3.js
function keccakP(s11, rounds = 24) {
  const B = new Uint32Array(5 * 2);
  for (let round = 24 - rounds; round < 24; round++) {
    for (let x2 = 0; x2 < 10; x2++)
      B[x2] = s11[x2] ^ s11[x2 + 10] ^ s11[x2 + 20] ^ s11[x2 + 30] ^ s11[x2 + 40];
    ...
    let curH = s11[2];
    let curL = s11[3];
    for (let t40 = 0; t40 < 24; t40++) {
      const shift = SHA3_ROTL[t40];
      const Th = rotlH(curH, curL, shift);
      const Tl = rotlL(curH, curL, shift);
      const PI = SHA3_PI[t40];
      curH = s11[PI];
      curL = s11[PI + 1];
      s11[PI] = Th;
      s11[PI + 1] = Tl;
  ...
  "../monorepo/platform/node_modules/@noble/hashes/esm/sha3.js"() {
    ...
    for (let round = 0, R = _1n, x2 = 1, y2 = 0; round < 24; round++) {
      ...
      for (let j = 0; j < 7; j++) {
        ...
        if (R & _2n)
          t40 ^= _1n << (_1n << /* @__PURE__ */ BigInt(j)) - _1n;
      }
      _SHA3_IOTA.push(t40);
    }
    ...
    SHA3_IOTA_H = IOTAS[0];
    SHA3_IOTA_L = IOTAS[1];
    rotlH = (h10, l8, s11) => s11 > 32 ? rotlBH(h10, l8, s11) : rotlSH(h10, l8, s11);
    rotlL = (h10, l8, s11) => s11 > 32 ? rotlBL(h10, l8, s11) : rotlSL(h10, l8, s11);
...
// ../monorepo/platform/node_modules/viem/_esm/utils/hash/keccak256.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/hash/hashSignature.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/hash/normalizeSignature.js
function normalizeSignature(signature) {
  ...
  let result = "";
  let valid = false;
  for (let i21 = 0; i21 < signature.length; i21++) {
    const char = signature[i21];
    if (["(", ")", ","].includes(char))
      active = true;
    if (char === "(")
      level++;
    ...
    if (char === " ") {
      if (signature[i21 - 1] !== "," && current !== "," && current !== ",(") {
        current = "";
        active = false;
      }
      continue;
...
// ../monorepo/platform/node_modules/viem/_esm/utils/hash/toSignature.js
var toSignature;
...
// ../monorepo/platform/node_modules/viem/_esm/utils/hash/toSignatureHash.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/hash/toEventSelector.js
var toEventSelector;
...
// ../monorepo/platform/node_modules/viem/_esm/errors/address.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/lru.js
var LruMap;
var init_lru = __esm({
  "../monorepo/platform/node_modules/viem/_esm/utils/lru.js"() {
...
// ../monorepo/platform/node_modules/viem/_esm/utils/address/getAddress.js
function checksumAddress(address_, chainId) {
  ...
  for (let i21 = 0; i21 < 40; i21 += 2) {
    if (hash3[i21 >> 1] >> 4 >= 8 && address[i21]) {
      address[i21] = address[i21].toUpperCase();
    }
    if ((hash3[i21 >> 1] & 15) >= 8 && address[i21 + 1]) {
      address[i21 + 1] = address[i21 + 1].toUpperCase();
    }
  }
...
// ../monorepo/platform/node_modules/viem/_esm/utils/address/isAddress.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/data/concat.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/data/slice.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/regex.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/encodeAbiParameters.js
...
function prepareParams({ params, values }) {
  ...
  for (let i21 = 0; i21 < params.length; i21++) {
    preparedParams.push(prepareParam({ param: params[i21], value: values[i21] }));
  }
...
function encodeParams(preparedParams) {
  let staticSize = 0;
  for (let i21 = 0; i21 < preparedParams.length; i21++) {
    const { dynamic, encoded } = preparedParams[i21];
    if (dynamic)
      staticSize += 32;
    else
...
function encodeArray(value, { length, param }) {
  ...
  const preparedParams = [];
  for (let i21 = 0; i21 < value.length; i21++) {
    const preparedParam = prepareParam({ param, value: value[i21] });
...
function encodeString(value) {
  ...
  const parts = [];
  for (let i21 = 0; i21 < partsLength; i21++) {
    parts.push(padHex(slice(hexValue, i21 * 32, (i21 + 1) * 32), {
      dir: "right"
    }));
  }
  return {
...
function encodeTuple(value, { param }) {
  let dynamic = false;
  const preparedParams = [];
  for (let i21 = 0; i21 < param.components.length; i21++) {
    const param_ = param.components[i21];
    const index2 = Array.isArray(value) ? i21 : param_.name;
...
// ../monorepo/platform/node_modules/viem/_esm/utils/hash/toFunctionSelector.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/getAbiItem.js
...
// ../monorepo/platform/node_modules/viem/_esm/accounts/utils/parseAccount.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/prepareEncodeFunctionData.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/encodeFunctionData.js
...
// ../monorepo/platform/node_modules/viem/_esm/constants/solidity.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/cursor.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/cursor.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/encoding/fromBytes.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/decodeAbiParameters.js
...
function decodeArray(cursor, param, { length, staticPosition }) {
  if (!length) {
    ...
    let consumed2 = 0;
    const value2 = [];
    for (let i21 = 0; i21 < length2; ++i21) {
      cursor.setPosition(startOfData + (dynamicChild ? i21 * 32 : consumed2));
  ...
  if (hasDynamicChild(param)) {
    ...
    const value2 = [];
    for (let i21 = 0; i21 < length; ++i21) {
      cursor.setPosition(start + i21 * 32);
...
function decodeTuple(cursor, param, { staticPosition }) {
  ...
  if (hasDynamicChild(param)) {
    ...
    const start = staticPosition + offset;
    for (let i21 = 0; i21 < param.components.length; ++i21) {
      const component = param.components[i21];
      cursor.setPosition(start + consumed);
      const [data, consumed_] = decodeParameter(cursor, component, {
        staticPosition: start
      });
      consumed += consumed_;
      value[hasUnnamedChild ? i21 : component?.name] = data;
    }
    cursor.setPosition(staticPosition + 32);
    return [value, 32];
  }
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/decodeErrorResult.js
function decodeErrorResult(parameters) {
  ...
  const abiItem = abi_.find((x2) => x2.type === "error" && signature === toFunctionSelector(formatAbiItem2(x2)));
  if (!abiItem)
...
// ../monorepo/platform/node_modules/viem/_esm/utils/stringify.js
var stringify;
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/formatAbiItemWithArgs.js
function formatAbiItemWithArgs({ abiItem, args, includeFunctionName = true, includeName = false }) {
  ...
  if (!abiItem.inputs)
    return;
  return `${includeFunctionName ? abiItem.name : ""}(${abiItem.inputs.map((input, i21) => `${includeName && input.name ? `${input.name}: ` : ""}${typeof args[i21] === "object" ? stringify(args[i21]) : args[i21]}`).join(", ")})`;
}
...
// ../monorepo/platform/node_modules/viem/_esm/constants/unit.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/unit/formatUnits.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/unit/formatEther.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/unit/formatGwei.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/stateOverride.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/transaction.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/utils.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/contract.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/request.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/rpc.js
...
// ../monorepo/platform/node_modules/@noble/hashes/esm/_md.js
  ...
  "../monorepo/platform/node_modules/@noble/hashes/esm/_md.js"() {
    ...
    HashMD = class extends Hash {
      ...
      digestInto(out) {
        ...
        for (let i21 = pos; i21 < blockLen; i21++)
          buffer2[i21] = 0;
        ...
        for (let i21 = 0; i21 < outLen; i21++)
          oview.setUint32(4 * i21, state[i21], isLE2);
      }
      digest() {
...
// ../monorepo/platform/node_modules/@noble/hashes/esm/sha2.js
...
var init_sha2 = __esm({
  "../monorepo/platform/node_modules/@noble/hashes/esm/sha2.js"() {
    ...
    SHA256 = class extends HashMD {
      ...
      process(view, offset) {
        for (let i21 = 0; i21 < 16; i21++, offset += 4)
          SHA256_W[i21] = view.getUint32(offset, false);
        for (let i21 = 16; i21 < 64; i21++) {
          const W15 = SHA256_W[i21 - 15];
          const W2 = SHA256_W[i21 - 2];
          const s0 = rotr(W15, 7) ^ rotr(W15, 18) ^ W15 >>> 3;
          const s1 = rotr(W2, 17) ^ rotr(W2, 19) ^ W2 >>> 10;
          SHA256_W[i21] = s1 + SHA256_W[i21 - 7] + s0 + SHA256_W[i21 - 16] | 0;
        }
        let { A, B, C: C2, D, E: E2, F, G, H } = this;
        for (let i21 = 0; i21 < 64; i21++) {
          const sigma1 = rotr(E2, 6) ^ rotr(E2, 11) ^ rotr(E2, 25);
          const T1 = H + sigma1 + Chi(E2, F, G) + SHA256_K[i21] + SHA256_W[i21] | 0;
...
// ../monorepo/platform/node_modules/@noble/hashes/esm/hmac.js
var HMAC, hmac;
var init_hmac = __esm({
  "../monorepo/platform/node_modules/@noble/hashes/esm/hmac.js"() {
    init_utils2();
    HMAC = class extends Hash {
      constructor(hash3, _key) {
        ...
        for (let i21 = 0; i21 < pad4.length; i21++)
          pad4[i21] ^= 54;
...
// ../monorepo/platform/node_modules/@noble/curves/esm/abstract/utils.js
...
function bytesToHex2(bytes) {
  ...
  if (hasHexBuiltin)
    return bytes.toHex();
  let hex = "";
  for (let i21 = 0; i21 < bytes.length; i21++) {
    hex += hexes2[bytes[i21]];
  }
  return hex;
}
...
function numberToBytesBE(n8, len) {
  return hexToBytes2(n8.toString(16).padStart(len * 2, "0"));
}
function numberToBytesLE(n8, len) {
  return numberToBytesBE(n8, len).reverse();
}
function ensureBytes(title, hex, expectedLength) {
  ...
  if (typeof hex === "string") {
    try {
      ...
      throw new Error(title + " must be hex string or Uint8Array, cause: " + e37);
    }
...
function aInRange(title, n8, min, max) {
  if (!inRange(n8, min, max))
    throw new Error("expected valid " + title + ": " + min + " <= n < " + max + ", got " + n8);
}
function bitLen(n8) {
  let len;
  for (len = 0; n8 > _0n2; n8 >>= _1n2, len += 1)
    ;
  return len;
}
...
var init_utils4 = __esm({
  "../monorepo/platform/node_modules/@noble/curves/esm/abstract/utils.js"() {
    ...
    hexes2 = /* @__PURE__ */ Array.from({ length: 256 }, (_4, i21) => i21.toString(16).padStart(2, "0"));
    asciis = { _0: 48, _9: 57, A: 65, F: 70, a: 97, f: 102 };
    isPosBig = (n8) => typeof n8 === "bigint" && _0n2 <= n8;
    bitMask = (n8) => (_1n2 << BigInt(n8)) - _1n2;
...
// ../monorepo/platform/node_modules/@noble/curves/esm/abstract/modular.js
function mod(a20, b) {
  const result = a20 % b;
...
function invert(number, modulo) {
  ...
  let b = modulo;
  let x2 = _0n3, y2 = _1n3, u4 = _1n3, v = _0n3;
  while (a20 !== _0n3) {
    const q = b / a20;
    const r20 = b % a20;
    const m3 = x2 - u4 * q;
    const n8 = y2 - v * q;
    b = a20, a20 = r20, x2 = u4, y2 = v, u4 = m3, v = n8;
  }
  const gcd = b;
  if (gcd !== _1n3)
...
function sqrt3mod4(Fp, n8) {
  const p1div4 = (Fp.ORDER + _1n3) / _4n;
  const root = Fp.pow(n8, p1div4);
  if (!Fp.eql(Fp.sqr(root), n8))
    throw new Error("Cannot find square root");
  return root;
}
function sqrt5mod8(Fp, n8) {
  const p5div8 = (Fp.ORDER - _5n) / _8n;
  const n22 = Fp.mul(n8, _2n2);
  const v = Fp.pow(n22, p5div8);
  const nv = Fp.mul(n8, v);
  const i21 = Fp.mul(Fp.mul(nv, _2n2), v);
  const root = Fp.mul(nv, Fp.sub(i21, Fp.ONE));
  if (!Fp.eql(Fp.sqr(root), n8))
    throw new Error("Cannot find square root");
  return root;
}
function tonelliShanks(P) {
  ...
  return function tonelliSlow(Fp, n8) {
    if (Fp.is0(n8))
      return n8;
    if (FpLegendre(Fp, n8) !== 1)
      throw new Error("Cannot find square root");
    let M = S;
    let c4 = Fp.mul(Fp.ONE, cc);
    let t40 = Fp.pow(n8, Q);
    let R = Fp.pow(n8, Q1div2);
    while (!Fp.eql(t40, Fp.ONE)) {
      if (Fp.is0(t40))
        return Fp.ZERO;
      let i21 = 1;
      let t_tmp = Fp.sqr(t40);
      ...
      const exponent = _1n3 << BigInt(M - i21 - 1);
...
function FpInvertBatch(Fp, nums, passZero = false) {
  ...
  const multipliedAcc = nums.reduce((acc, num2, i21) => {
    if (Fp.is0(num2))
      return acc;
    inverted[i21] = acc;
  ...
  nums.reduceRight((acc, num2, i21) => {
    if (Fp.is0(num2))
      return acc;
    inverted[i21] = Fp.mul(acc, inverted[i21]);
    return Fp.mul(acc, num2);
  }, invertedAcc);
  return inverted;
}
function FpLegendre(Fp, n8) {
  const p1mod2 = (Fp.ORDER - _1n3) / _2n2;
  const powered = Fp.pow(n8, p1mod2);
...
// ../monorepo/platform/node_modules/@noble/curves/esm/abstract/curve.js
...
function calcOffsets(n8, window, wOpts) {
  const { windowSize, mask, maxNumber, shiftBy } = wOpts;
  let wbits = Number(n8 & mask);
  let nextN = n8 >> shiftBy;
  if (wbits > windowSize) {
    wbits -= maxNumber;
    nextN += _1n4;
  }
...
function validateMSMPoints(points, c4) {
  ...
  points.forEach((p13, i21) => {
    if (!(p13 instanceof c4))
      throw new Error("invalid point at index " + i21);
  });
}
function validateMSMScalars(scalars, field) {
  if (!Array.isArray(scalars))
    throw new Error("array of scalars expected");
  scalars.forEach((s11, i21) => {
    if (!field.isValid(s11))
      throw new Error("invalid scalar at index " + i21);
  });
}
function getW(P) {
...
function wNAF(c4, bits) {
  return {
    ...
    unsafeLadder(elm, n8, p13 = c4.ZERO) {
      let d7 = elm;
      while (n8 > _0n4) {
        if (n8 & _1n4)
          p13 = p13.add(d7);
    ...
    precomputeWindow(elm, W) {
      ...
      for (let window = 0; window < windows; window++) {
        base = p13;
        points.push(base);
        for (let i21 = 1; i21 < windowSize; i21++) {
          base = base.add(p13);
          points.push(base);
        }
        p13 = base.double();
     ...
     */
    wNAF(W, precomputes, n8) {
      let p13 = c4.ZERO;
      let f2 = c4.BASE;
      const wo = calcWOpts(W, bits);
      for (let window = 0; window < wo.windows; window++) {
        const { nextN, offset, isZero, isNeg, isNegF, offsetF } = calcOffsets(n8, window, wo);
        n8 = nextN;
        if (isZero) {
          f2 = f2.add(constTimeNegate(isNegF, precomputes[offsetF]));
        } else {
          p13 = p13.add(constTimeNegate(isNeg, precomputes[offset]));
        }
      }
      return { p: p13, f: f2 };
    },
     ...
     * @returns point
     */
    wNAFUnsafe(W, precomputes, n8, acc = c4.ZERO) {
      const wo = calcWOpts(W, bits);
      for (let window = 0; window < wo.windows; window++) {
        if (n8 === _0n4)
          break;
        const { nextN, offset, isZero, isNeg } = calcOffsets(n8, window, wo);
        n8 = nextN;
        if (isZero) {
          continue;
        } else {
    ...
    wNAFCached(P, n8, transform) {
      const W = getW(P);
      return this.wNAF(W, this.getPrecomputes(W, P, transform), n8);
    },
    wNAFCachedUnsafe(P, n8, transform, prev) {
      const W = getW(P);
      if (W === 1)
        return this.unsafeLadder(P, n8, prev);
      return this.wNAFUnsafe(W, this.getPrecomputes(W, P, transform), n8, prev);
    },
...
function pippenger(c4, fieldN, points, scalars) {
  ...
  let sum = zero;
  for (let i21 = lastBits; i21 >= 0; i21 -= windowSize) {
    buckets.fill(zero);
    for (let j = 0; j < slength; j++) {
      const scalar = scalars[j];
      const wbits2 = Number(scalar >> BigInt(i21) & MASK);
...
// ../monorepo/platform/node_modules/@noble/curves/esm/abstract/weierstrass.js
...
function weierstrassPoints(opts) {
  ...
  function weierstrassEquation(x2) {
    ...
    return Fp.add(Fp.add(x3, Fp.mul(x2, a20)), b);
  }
  ...
  const assertValidMemo = memoized((p13) => {
    if (p13.is0()) {
      if (CURVE.allowInfinityPoint && !Fp.is0(p13.py))
        return;
      throw new Error("bad point: ZERO");
    }
    const { x: x2, y: y2 } = p13.toAffine();
  ...
  class Point2 {
    ...
    static fromAffine(p13) {
      const { x: x2, y: y2 } = p13 || {};
      if (!p13 || !Fp.isValid(x2) || !Fp.isValid(y2))
        throw new Error("invalid affine point");
      if (p13 instanceof Point2)
        throw new Error("projective point not allowed");
      const is0 = (i21) => Fp.eql(i21, Fp.ZERO);
      if (is0(x2) && is0(y2))
        return Point2.ZERO;
      return new Point2(x2, y2, Fp.ONE);
    }
    get x() {
    ...
    static normalizeZ(points) {
      const toInv = FpInvertBatch(Fp, points.map((p13) => p13.pz));
      return points.map((p13, i21) => p13.toAffine(toInv[i21])).map(Point2.fromAffine);
    }
    /**
    ...
    add(other) {
      ...
      t310 = Fp.mul(t310, t42);
      t42 = Fp.add(t0, t1);
      t310 = Fp.sub(t310, t42);
      t42 = Fp.add(X1, Z1);
    ...
    multiply(scalar) {
      ...
      if (endo2) {
        ...
        const { p: p13, f: f2 } = this.wNAF(scalar);
        point = p13;
        fake = f2;
      }
...
function weierstrass(curveDef) {
  ...
  const { ProjectivePoint: Point2, normPrivateKeyToScalar, weierstrassEquation, isWithinCurveOrder } = weierstrassPoints({
    ...
    toBytes(_c, point, isCompressed) {
      const a20 = point.toAffine();
      const x2 = Fp.toBytes(a20.x);
      const cat = concatBytes3;
      abool("isCompressed", isCompressed);
      if (isCompressed) {
        return cat(Uint8Array.from([point.hasEvenY() ? 2 : 3]), x2);
      } else {
        return cat(Uint8Array.from([4]), x2, Fp.toBytes(a20.y));
      }
    },
    fromBytes(bytes) {
  ...
  class Signature {
    ...
    static fromDER(hex) {
      const { r: r20, s: s11 } = DER.toSig(ensureBytes("DER", hex));
  ...
  function prepSig(msgHash, privateKey, opts = defaultSigOpts) {
    ...
    if (ent != null && ent !== false) {
      const e37 = ent === true ? randomBytes2(Fp.BYTES) : ent;
      seedArgs.push(ensureBytes("extraEntropy", e37));
    }
...
function SWUFpSqrtRatio(Fp, Z) {
  const q = Fp.ORDER;
  let l8 = _0n5;
  for (let o19 = q - _1n5; o19 % _2n3 === _0n5; o19 /= _2n3)
    l8 += _1n5;
  const c1 = l8;
  ...
  const c6 = Fp.pow(Z, c22);
  const c7 = Fp.pow(Z, (c22 + _1n5) / _2n3);
  let sqrtRatio = (u4, v) => {
    let tv1 = c6;
    let tv2 = Fp.pow(v, c4);
    let tv3 = Fp.sqr(tv2);
    ...
    DER = {
      ...
      _tlv: {
        encode: (tag, data) => {
          ...
          const t40 = numberToHexUnpadded(tag);
          return t40 + lenLen + len + data;
        },
...
// ../monorepo/platform/node_modules/@noble/curves/esm/_shortw_utils.js
...
// ../monorepo/platform/node_modules/@noble/curves/esm/abstract/hash-to-curve.js
function i2osp(value, length) {
  ...
  for (let i21 = length - 1; i21 >= 0; i21--) {
    res[i21] = value & 255;
    value >>>= 8;
  }
...
function strxor(a20, b) {
  ...
  for (let i21 = 0; i21 < a20.length; i21++) {
    arr[i21] = a20[i21] ^ b[i21];
  }
  return arr;
}
function anum(item) {
...
function expand_message_xmd(msg, DST, lenInBytes, H) {
  ...
  for (let i21 = 1; i21 <= ell; i21++) {
    const args = [strxor(b_0, b[i21 - 1]), i2osp(i21 + 1, 1), DST_prime];
    b[i21] = H(concatBytes3(...args));
  }
...
function hash_to_field(msg, count, options) {
  ...
  const { p: p13, k: k2, m: m3, hash: hash3, expand, DST: _DST } = options;
  abytes2(msg);
  anum(count);
  ...
  for (let i21 = 0; i21 < count; i21++) {
    const e37 = new Array(m3);
    for (let j = 0; j < m3; j++) {
      const elm_offset = L * (j + i21 * m3);
      const tv = prb.subarray(elm_offset, elm_offset + L);
      e37[j] = mod(os2ip(tv), p13);
    }
    u4[i21] = e37;
  }
  return u4;
...
function isogenyMap(field, map) {
  const coeff = map.map((i21) => Array.from(i21).reverse());
  return (x2, y2) => {
    const [xn, xd, yn, yd] = coeff.map((val) => val.reduce((acc, i21) => field.add(field.mul(acc, x2), i21)));
...
function createHasher2(Point2, mapToCurve, defaults) {
  ...
  return {
    ...
    mapToCurve(scalars) {
      ...
      for (const i21 of scalars)
        if (typeof i21 !== "bigint")
          throw new Error("expected array of bigints");
...
// ../monorepo/platform/node_modules/@noble/curves/esm/secp256k1.js
...
function lift_x(x2) {
  ...
  if (y2 % _2n4 !== _0n6)
    y2 = modP(-y2);
  const p13 = new Point(x2, y2, _1n6);
  p13.assertValidity();
  return p13;
}
...
function schnorrSign(message, privateKey, auxRand = randomBytes(32)) {
  ...
  const t40 = numTo32b(d7 ^ num(taggedHash("BIP0340/aux", a20)));
  const rand = taggedHash("BIP0340/nonce", t40, px, m3);
  const k_ = modN(num(rand));
  if (k_ === _0n6)
    throw new Error("sign failed: k is zero");
  const { bytes: rx, scalar: k2 } = schnorrGetExtPubKey(k_);
  const e37 = challenge(rx, px, m3);
  const sig = new Uint8Array(64);
  sig.set(rx, 0);
  sig.set(numTo32b(modN(k2 + e37 * d7)), 32);
...
function schnorrVerify(signature, message, publicKey) {
  ...
  try {
    ...
    if (!inRange(s11, _1n6, secp256k1N))
      return false;
    const e37 = challenge(numTo32b(r20), pointToBytes(P), m3);
    const R = GmulAdd(P, s11, modN(-e37));
...
var init_secp256k1 = __esm({
  "../monorepo/platform/node_modules/@noble/curves/esm/secp256k1.js"() {
    ...
    numTo32b = (n8) => numberToBytesBE(n8, 32);
    ...
    secp256k1_hasher = /* @__PURE__ */ (() => createHasher2(secp256k1.ProjectivePoint, (scalars) => {
      const { x: x2, y: y2 } = mapSWU(Fpk1.create(scalars[0]));
      return isoMap(x2, y2);
    }, {
...
// ../monorepo/platform/node_modules/viem/_esm/errors/node.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/errors/getNodeError.js
function getNodeError(err, args) {
  const message = (err.details || "").toLowerCase();
  const executionRevertedError = err instanceof BaseError2 ? err.walk((e37) => e37?.code === ExecutionRevertedError.code) : err;
...
// ../monorepo/platform/node_modules/viem/_esm/utils/formatters/extract.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/formatters/transactionRequest.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/stateOverride.js
...
// ../monorepo/platform/node_modules/viem/_esm/constants/number.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/transaction/assertRequest.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/address/isAddressEqual.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/decodeFunctionResult.js
...
// ../monorepo/platform/node_modules/ox/_esm/core/version.js
var version3;
...
// ../monorepo/platform/node_modules/ox/_esm/core/internal/errors.js
function getVersion() {
  return version3;
}
...
// ../monorepo/platform/node_modules/ox/_esm/core/Errors.js
...
// ../monorepo/platform/node_modules/ox/_esm/core/internal/bytes.js
...
// ../monorepo/platform/node_modules/ox/_esm/core/internal/hex.js
...
// ../monorepo/platform/node_modules/ox/_esm/core/Json.js
...
// ../monorepo/platform/node_modules/ox/_esm/core/Bytes.js
...
// ../monorepo/platform/node_modules/ox/_esm/core/Hex.js
...
var init_Hex = __esm({
  "../monorepo/platform/node_modules/ox/_esm/core/Hex.js"() {
    ...
    hexes3 = /* @__PURE__ */ Array.from({ length: 256 }, (_v, i21) => i21.toString(16).padStart(2, "0"));
...
// ../monorepo/platform/node_modules/ox/_esm/core/Withdrawal.js
...
// ../monorepo/platform/node_modules/ox/_esm/core/BlockOverrides.js
...
// ../monorepo/platform/node_modules/viem/_esm/constants/abis.js
...
// ../monorepo/platform/node_modules/viem/_esm/constants/contract.js
...
// ../monorepo/platform/node_modules/viem/_esm/constants/contracts.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/chain.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/encodeDeployData.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/chain/getChainContractAddress.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/errors/getCallError.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/promise/withResolvers.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/promise/createBatchScheduler.js
  ...
  const exec = async () => {
    ...
    fn(args).then((data) => {
      if (sort && Array.isArray(data))
        data.sort(sort);
      for (let i21 = 0; i21 < scheduler.length; i21++) {
        const { resolve } = scheduler[i21];
        resolve?.([data[i21], data]);
      }
    }).catch((err) => {
      for (let i21 = 0; i21 < scheduler.length; i21++) {
        const { reject } = scheduler[i21];
        reject?.(err);
      }
    });
  };
...
// ../monorepo/platform/node_modules/viem/_esm/errors/ccip.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/decodeFunctionData.js
function decodeFunctionData(parameters) {
  const { abi: abi2, data } = parameters;
  const signature = slice(data, 0, 4);
  const description = abi2.find((x2) => x2.type === "function" && signature === toFunctionSelector(formatAbiItem2(x2)));
  if (!description)
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/encodeErrorResult.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/encodeFunctionResult.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/ens/localBatchGatewayRequest.js
async function localBatchGatewayRequest(parameters) {
  const { data, ccipRequest: ccipRequest2 } = parameters;
  const { args: [queries] } = decodeFunctionData({ abi: batchGatewayAbi, data });
  const failures = [];
  const responses = [];
  await Promise.all(queries.map(async (query, i21) => {
    try {
      responses[i21] = query.urls.includes(localBatchGatewayUrl) ? await localBatchGatewayRequest({ data: query.data, ccipRequest: ccipRequest2 }) : await ccipRequest2(query);
      failures[i21] = false;
    } catch (err) {
      failures[i21] = true;
      responses[i21] = encodeError(err);
    }
  }));
...
// ../monorepo/platform/node_modules/viem/_esm/utils/ccip.js
var ccip_exports = {};
...
async function ccipRequest({ data, sender, urls }) {
  ...
  for (let i21 = 0; i21 < urls.length; i21++) {
    const url = urls[i21];
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/call.js
...
// ../monorepo/platform/node_modules/eventemitter3/index.js
var require_eventemitter3 = __commonJS({
  "../monorepo/platform/node_modules/eventemitter3/index.js"(exports, module) {
    "use strict";
    ...
    EventEmitter2.prototype.listeners = function listeners(event) {
      ...
      for (var i21 = 0, l8 = handlers.length, ee = new Array(l8); i21 < l8; i21++) {
        ee[i21] = handlers[i21].fn;
      }
      return ee;
    };
    ...
    EventEmitter2.prototype.emit = function emit(event, a1, a22, a32, a42, a52) {
      ...
      var listeners = this._events[evt], len = arguments.length, args, i21;
      if (listeners.fn) {
        ...
        for (i21 = 1, args = new Array(len - 1); i21 < len; i21++) {
          args[i21 - 1] = arguments[i21];
        }
        listeners.fn.apply(listeners.context, args);
      } else {
        var length = listeners.length, j;
        for (i21 = 0; i21 < length; i21++) {
          if (listeners[i21].once) this.removeListener(event, listeners[i21].fn, void 0, true);
          switch (len) {
            case 1:
              listeners[i21].fn.call(listeners[i21].context);
              break;
            case 2:
              listeners[i21].fn.call(listeners[i21].context, a1);
              break;
            case 3:
              listeners[i21].fn.call(listeners[i21].context, a1, a22);
              break;
            case 4:
              listeners[i21].fn.call(listeners[i21].context, a1, a22, a32);
              break;
            default:
              if (!args) for (j = 1, args = new Array(len - 1); j < len; j++) {
                args[j - 1] = arguments[j];
              }
              listeners[i21].fn.apply(listeners[i21].context, args);
          }
        }
      }
      return true;
    ...
    EventEmitter2.prototype.removeListener = function removeListener(event, fn, context, once) {
      ...
      if (listeners.fn) {
        ...
        for (var i21 = 0, events = [], length = listeners.length; i21 < length; i21++) {
          if (listeners[i21].fn !== fn || once && !listeners[i21].once || context && listeners[i21].context !== context) {
            events.push(listeners[i21]);
          }
        }
...
// ../monorepo/platform/node_modules/canonicalize/lib/canonicalize.js
var require_canonicalize = __commonJS({
  "../monorepo/platform/node_modules/canonicalize/lib/canonicalize.js"(exports, module) {
    "use strict";
    module.exports = function serialize(object) {
      ...
      if (Array.isArray(object)) {
        const values2 = object.reduce((t40, cv, ci) => {
          const comma = ci === 0 ? "" : ",";
          const value = cv === void 0 || typeof cv === "symbol" ? null : cv;
          return `${t40}${comma}${serialize(value)}`;
        }, "");
        return `[${values2}]`;
      }
      const values = Object.keys(object).sort().reduce((t40, cv) => {
        if (object[cv] === void 0 || typeof object[cv] === "symbol") {
          return t40;
        }
        const comma = t40.length === 0 ? "" : ",";
        return `${t40}${comma}${serialize(cv)}:${serialize(object[cv])}`;
      }, "");
      return `{${values}}`;
    };
  }
...
// ../monorepo/platform/node_modules/fetch-retry/dist/fetch-retry.umd.js
var require_fetch_retry_umd = __commonJS({
  "../monorepo/platform/node_modules/fetch-retry/dist/fetch-retry.umd.js"(exports, module) {
...
// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/analytics-events.mjs
var t = { path: "/api/v1/analytics_events", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/apps.mjs
var p = { path: "/api/v1/apps/:app_id", method: "GET" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/coinbase.mjs
var n = { path: "/api/v1/funding/coinbase_on_ramp/init", method: "POST" };
var a = { path: "/api/v1/funding/coinbase_on_ramp/status", method: "GET" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/cross-app.mjs
var p2 = { path: "/api/v1/apps/:app_id/cross-app/connections", method: "GET" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/custom-jwt-account.mjs
var t2 = { path: "/api/v1/custom_jwt_account/authenticate", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/farcaster.mjs
var a2 = { path: "/api/v1/farcaster/init", method: "POST" };
...
// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/guest.mjs
var t4 = { path: "/api/v1/guest/authenticate", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/mfa-passkey.mjs
var a3 = { path: "/api/v1/mfa/passkeys/init", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/mfa-passwordless-sms.mjs
var p4 = { path: "/api/v1/mfa/passwordless_sms/init", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/oauth.mjs
var t5 = { path: "/api/v1/oauth/authenticate", method: "POST" };
var a4 = { path: "/api/v1/oauth/init", method: "POST" };
var h2 = { path: "/api/v1/oauth/link", method: "POST" };
var o = { path: "/api/v1/oauth/unlink", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/passkey.mjs
var t6 = { path: "/api/v1/passkeys/link", method: "POST" };
var a5 = { path: "/api/v1/passkeys/authenticate", method: "POST" };
...
// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/passwordless.mjs
var s2 = { path: "/api/v1/passwordless/authenticate", method: "POST" };
var a6 = { path: "/api/v1/passwordless/init", method: "POST" };
...
// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/passwordless-sms.mjs
var s3 = { path: "/api/v1/passwordless_sms/authenticate", method: "POST" };
var a7 = { path: "/api/v1/passwordless_sms/init", method: "POST" };
...
// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/recovery.mjs
var e5 = { path: "/api/v1/embedded_wallets/:address/recovery/key_material", method: "POST" };
var a8 = { path: "/api/v1/recovery/oauth/init", method: "POST" };
...
// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/types.mjs
var e6 = (e37, c4) => c4 ? Object.entries(c4).reduce(((e38, [c5, r20]) => e38.replace(`:${c5}`, `${r20}`)), e37) : e37;

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/sessions.mjs
var s4 = { path: "/api/v1/sessions", method: "POST" };
var o3 = { path: "/api/v1/sessions/logout", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/smart-wallets.mjs
var p8 = { path: "/api/v1/apps/:app_id/smart_wallets", method: "GET" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/siwe.mjs
var t10 = { path: "/api/v1/siwe/init", method: "POST" };
var i3 = { path: "/api/v1/siwe/authenticate", method: "POST" };
var a9 = { path: "/api/v1/siwe/link", method: "POST" };
var e7 = { path: "/api/v1/siwe/link_smart_wallet", method: "POST" };
var h4 = { path: "/api/v1/siwe/unlink", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/siws.mjs
var t11 = { path: "/api/v1/siws/init", method: "POST" };
var i4 = { path: "/api/v1/siws/authenticate", method: "POST" };
var a10 = { path: "/api/v1/siws/link", method: "POST" };
var h5 = { path: "/api/v1/siws/unlink", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/terms.mjs
var e8 = { path: "/api/v1/users/me/accept_terms", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/moonpay.mjs
var o4 = { path: "/api/v1/plugins/moonpay_on_ramp/sign", method: "POST" };

// ../monorepo/platform/node_modules/@privy-io/routes/dist/esm/wallet-api.mjs
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/AppApi.mjs
var r2 = class {
  getConfig() {
  ...
  constructor(t40) {
    this._privyInternal = t40;
  }
};

// ../monorepo/platform/node_modules/jose/dist/browser/lib/buffer_utils.js
var encoder = new TextEncoder();
var decoder = new TextDecoder();
var MAX_INT32 = 2 ** 32;

// ../monorepo/platform/node_modules/jose/dist/browser/runtime/base64url.js
var encodeBase64 = (input) => {
  ...
  const arr = [];
  for (let i21 = 0; i21 < unencoded.length; i21 += CHUNK_SIZE) {
    arr.push(String.fromCharCode.apply(null, unencoded.subarray(i21, i21 + CHUNK_SIZE)));
  }
...
var decodeBase64 = (encoded) => {
  ...
  for (let i21 = 0; i21 < binary.length; i21++) {
    bytes[i21] = binary.charCodeAt(i21);
  }
  return bytes;
};
var decode = (input) => {
...
// ../monorepo/platform/node_modules/jose/dist/browser/util/errors.js
...
// ../monorepo/platform/node_modules/jose/dist/browser/lib/is_object.js
...
// ../monorepo/platform/node_modules/jose/dist/browser/util/base64url.js
...
// ../monorepo/platform/node_modules/jose/dist/browser/util/decode_jwt.js
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/Token.mjs
var t13 = class _t {
  static parse(e37) {
    try {
      return new _t(e37);
  ...
  isExpired(e37 = 0) {
    return Date.now() >= 1e3 * (this.expiration - e37);
  }
  constructor(t40) {
    this.value = t40, this._decoded = decodeJwt(t40);
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/CrossAppApi.mjs
var t14 = class _t {
  async updateOnCrossAppAuthentication(r20, e37) {
    let s11 = e37.access_token, o19 = _t.providerAccessTokenStorageKey(r20);
    await this._storage.put(o19, s11);
  }
  async getProviderAccessToken(r20) {
    let s11 = _t.providerAccessTokenStorageKey(r20), o19 = await this._storage.get(s11);
    if ("string" != typeof o19) return null;
    try {
      if (new t13(o19).isExpired()) throw Error("JWT is expired");
      return o19;
    } catch {
  ...
  constructor(r20, e37) {
    this._privyInternal = r20, this._storage = e37;
  }
};
t14.providerAccessTokenStorageKey = (r20) => `privy:cross-app:${r20}`;

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/DelegatedWalletsApi.mjs
var t15 = class {
  async revoke() {
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/add-privy-rpc-to-chain.mjs
function r3(r20, p13) {
  return { ...r20, rpcUrls: { ...r20.rpcUrls, privy: { http: [p13] } } };
}

// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/arbitrum.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/arbitrumSepolia.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/avalanche.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/avalancheFuji.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/base.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/baseSepolia.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/berachainArtio.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/bsc.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/celo.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/celoAlfajores.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/filecoin.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/filecoinCalibration.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/garnetHolesky.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/holesky.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/linea.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/lineaTestnet.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/lukso.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/mainnet.mjs
var t21 = { id: 1, network: "homestead", name: "Ethereum", nativeCurrency: { name: "Ether", symbol: "ETH", decimals: 18 }, rpcUrls: { privy: { http: ["https://mainnet.rpc.privy.systems"] }, alchemy: { http: ["https://eth-mainnet.g.alchemy.com/v2"], webSocket: ["wss://eth-mainnet.g.alchemy.com/v2"] }, infura: { http: ["https://mainnet.infura.io/v3"], webSocket: ["wss://mainnet.infura.io/ws/v3"] }, default: { http: ["https://cloudflare-eth.com"] }, public: { http: ["https://cloudflare-eth.com"] } }, blockExplorers: { etherscan: { name: "Etherscan", url: "https://etherscan.io" }, default: { name: "Etherscan", url: "https://etherscan.io" } } };

// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/optimism.mjs
var t22 = { id: 10, name: "OP Mainnet", network: "optimism", nativeCurrency: { name: "Ether", symbol: "ETH", decimals: 18 }, rpcUrls: { privy: { http: ["https://optimism-mainnet.rpc.privy.systems"] }, alchemy: { http: ["https://opt-mainnet.g.alchemy.com/v2"], webSocket: ["wss://opt-mainnet.g.alchemy.com/v2"] }, infura: { http: ["https://optimism-mainnet.infura.io/v3"], webSocket: ["wss://optimism-mainnet.infura.io/ws/v3"] }, default: { http: ["https://mainnet.optimism.io"] }, public: { http: ["https://mainnet.optimism.io"] } }, blockExplorers: { etherscan: { name: "Etherscan", url: "https://optimistic.etherscan.io" }, default: { name: "Optimism Explorer", url: "https://explorer.optimism.io" } } };

// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/optimismSepolia.mjs
var t23 = { id: 11155420, name: "Optimism Sepolia", network: "optimism-sepolia", nativeCurrency: { name: "Sepolia Ether", symbol: "ETH", decimals: 18 }, rpcUrls: { privy: { http: ["https://optimism-sepolia.rpc.privy.systems"] }, default: { http: ["https://sepolia.optimism.io"] }, public: { http: ["https://sepolia.optimism.io"] }, infura: { http: ["https://optimism-sepolia.infura.io/v3"] } }, blockExplorers: { default: { name: "Blockscout", url: "https://optimism-sepolia.blockscout.com" } }, testnet: true };

// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/polygon.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/polygonAmoy.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/redstone.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/sepolia.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/zora.mjs
var r5 = { id: 7777777, name: "Zora", network: "zora", nativeCurrency: { decimals: 18, name: "Ether", symbol: "ETH" }, rpcUrls: { default: { http: ["https://rpc.zora.energy"], webSocket: ["wss://rpc.zora.energy"] }, public: { http: ["https://rpc.zora.energy"], webSocket: ["wss://rpc.zora.energy"] } }, blockExplorers: { default: { name: "Explorer", url: "https://explorer.zora.energy" } } };

// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/zoraSepolia.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/definitions/zoraTestnet.mjs
...
// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/default-supported-chains.mjs
var x = [t21, e21, e16, t16, r4, t22, t23, o6, o7, e14, e15, i7, i8, e12, e13, t18, t19, e19, e17, e18, a15, t17, r5, e23, e22, e20, t20];
var C = new Set(x.map(((i21) => i21.id)));

// ../monorepo/platform/node_modules/@privy-io/chains/dist/esm/ethereum/dedupe-supported-chains.mjs
var t24 = (t40) => t40.map(((t41) => {
  if (t41.rpcUrls.privyWalletOverride) return t41;
  let n8 = x.find(((i21) => i21.id === t41.id)), s11 = n8?.rpcUrls.privy?.http[0];
  return s11 ? r3(t41, s11) : t41;
}));

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/Error.mjs
var r6 = class extends Error {
  constructor({ error: r20, code: e37 }) {
    super(r20), this.error = r20, this.code = e37;
  }
};
var e24 = class extends Error {
  constructor({ error: r20, code: e37 }) {
    super(r20), this.code = e37, this.error = r20;
  }
};
var o8 = class extends Error {
  constructor({ error: r20, code: e37, response: o19 }) {
    super(r20), this.code = e37, this.error = r20, this.response = o19;
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/wallet-api/unified-wallet.mjs
var e25 = (e37) => !!e37.id && "privy-v2" === e37.recovery_method;

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/EmbeddedBitcoinWalletProvider.mjs
var r7 = class {
  async sign({ message: e37 }) {
    return await this.request({ method: "sign", params: { message: new TextDecoder("utf8").decode(e37) } });
  }
  async signTransaction({ psbt: e37 }) {
    return await this.request({ method: "signTransaction", params: { psbt: e37 } });
  }
  async request(r20) {
  ...
  async handleIFrameRpc(t40) {
    try {
      let e37 = await this._privyInternal.getAccessTokenInternal();
      if (!e37) throw Error("Missing access token. User must be authenticated.");
      return this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_rpc_started", { method: t40.method, address: this._account.address }), (await this._proxy.rpcWallet({ accessToken: e37, request: t40, entropyId: this._entropyId, entropyIdVerifier: this._entropyIdVerifier, hdWalletIndex: this._account.wallet_index, chainType: this._account.chain_type })).response.data;
    } catch (r20) {
      console.error(r20);
      let s11 = r20 instanceof Error ? r20.message : "Unable to make wallet request";
      throw this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_rpc_failed", { method: t40.method, address: this._account.address, error: s11 }), new e24({ code: "embedded_wallet_request_error", error: s11 });
    }
  }
  toJSON() {
    return `PrivyEmbeddedBitcoinProvider { address: '${this._account.address}', request: [Function] }`;
  }
  constructor({ proxy: e37, privyInternal: t40, account: r20, entropyId: s11, entropyIdVerifier: a20 }) {
    this._proxy = e37, this._privyInternal = t40, this._account = r20, this._entropyId = s11, this._entropyIdVerifier = a20;
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/types.mjs
var t25 = ["error", "invalid_request_arguments", "wallet_not_on_device", "invalid_recovery_pin", "insufficient_funds", "mfa_timeout", "missing_or_invalid_mfa", "mfa_verification_max_attempts_reached"];

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/errors.mjs
var t26;
var r8 = ((t26 = {}).MISSING_OR_INVALID_PRIVY_APP_ID = "missing_or_invalid_privy_app_id", t26.MISSING_OR_INVALID_PRIVY_ACCOUNT_ID = "missing_or_invalid_privy_account_id", t26.INVALID_DATA = "invalid_data", t26.LINKED_TO_ANOTHER_USER = "linked_to_another_user", t26.ALLOWLIST_REJECTED = "allowlist_rejected", t26.OAUTH_USER_DENIED = "oauth_user_denied", t26.UNKNOWN_AUTH_ERROR = "unknown_auth_error", t26.USER_EXITED_AUTH_FLOW = "exited_auth_flow", t26.MUST_BE_AUTHENTICATED = "must_be_authenticated", t26.UNKNOWN_CONNECT_WALLET_ERROR = "unknown_connect_wallet_error", t26.GENERIC_CONNECT_WALLET_ERROR = "generic_connect_wallet_error", t26.CLIENT_REQUEST_TIMEOUT = "client_request_timeout", t26.INVALID_CREDENTIALS = "invalid_credentials", t26);
var s6 = class extends Error {
  ...
  constructor(e37, t40, r20) {
    super(e37), t40 instanceof Error && (this.cause = t40), this.privyErrorCode = r20;
  }
};
var o9 = class extends Error {
  constructor(e37, t40) {
    super(t40), this.type = e37;
  }
};
var i9 = class extends s6 {
  constructor(e37, t40, r20) {
    super(e37, t40, r20), this.type = "connector_error";
  }
};
var d2 = class extends Error {
  constructor(e37, t40, r20) {
    super(e37), this.code = t40, this.data = r20;
  }
};
function _(t40) {
  let r20 = t40.type;
  return "string" == typeof r20 && t25.includes(r20);
}
function E(e37) {
  return _(e37) && "wallet_not_on_device" === e37.type;
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/wallet-api/create.mjs
async function r9(r20, { request: t40, headers: o19 }) {
  return await r20.fetchPrivyRoute(t12, { body: t40, headers: o19 });
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/stack/walletCreate.mjs
async function t27({ context: t40, chainType: i21, idempotencyKey: o19 }) {
  return { wallet: await r9(t40, { request: { chain_type: i21, owner_id: void 0 }, headers: o19 ? { "privy-idempotency-key": o19 } : void 0 }) };
}

// ../monorepo/platform/node_modules/viem/_esm/utils/getAction.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/encodeEventTopics.js
init_abi();

// ../monorepo/platform/node_modules/viem/_esm/errors/log.js
init_base();
...
function encodeEventTopics(parameters) {
  ...
  if (args && "inputs" in abiItem) {
    ...
    if (args_.length > 0) {
      topics = indexedInputs?.map((param, i21) => {
        if (Array.isArray(args_[i21]))
          return args_[i21].map((_4, j) => encodeArg({ param, value: args_[i21][j] }));
        return typeof args_[i21] !== "undefined" && args_[i21] !== null ? encodeArg({ param, value: args_[i21] }) : null;
      }) ?? [];
    }
  }
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/createContractEventFilter.js
init_toHex();

// ../monorepo/platform/node_modules/viem/_esm/utils/filters/createFilterRequestScope.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/estimateContractGas.js
init_parseAccount();
init_encodeFunctionData();

// ../monorepo/platform/node_modules/viem/_esm/utils/errors/getContractError.js
init_abi();
init_base();
init_contract();
init_request();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/estimateGas.js
init_parseAccount();
init_base();

// ../monorepo/platform/node_modules/viem/_esm/accounts/utils/publicKeyToAddress.js
init_getAddress();
init_keccak256();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/signature/recoverPublicKey.js
init_isHex();
init_size();
init_fromHex();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/signature/recoverAddress.js
async function recoverAddress({ hash: hash3, signature }) {
  return publicKeyToAddress(await recoverPublicKey({ hash: hash3, signature }));
}

// ../monorepo/platform/node_modules/viem/_esm/utils/authorization/hashAuthorization.js
init_concat();
init_toBytes();
init_toHex();

// ../monorepo/platform/node_modules/viem/_esm/utils/encoding/toRlp.js
init_base();
init_cursor2();
init_toBytes();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/authorization/recoverAuthorizationAddress.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/estimateGas.js
init_formatEther();
init_formatGwei();
init_base();
init_transaction();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/errors/getEstimateGasError.js
init_node();
init_getNodeError();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/wallet/prepareTransactionRequest.js
init_parseAccount();

// ../monorepo/platform/node_modules/viem/_esm/errors/fee.js
init_formatGwei();
init_base();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/estimateMaxPriorityFeePerGas.js
init_fromHex();

// ../monorepo/platform/node_modules/viem/_esm/errors/block.js
init_base();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getBlock.js
init_toHex();

// ../monorepo/platform/node_modules/viem/_esm/utils/formatters/transaction.js
init_fromHex();
var transactionType = {
  "0x0": "legacy",
  "0x1": "eip2930",
...
// ../monorepo/platform/node_modules/viem/_esm/utils/formatters/block.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getGasPrice.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/estimateFeesPerGas.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getTransactionCount.js
init_fromHex();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/blob/blobsToCommitments.js
init_toBytes();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/blob/blobsToProofs.js
init_toBytes();
init_toHex();
function blobsToProofs(parameters) {
  ...
  const proofs = [];
  for (let i21 = 0; i21 < blobs.length; i21++) {
    const blob = blobs[i21];
    const commitment = commitments[i21];
    proofs.push(Uint8Array.from(kzg.computeBlobKzgProof(blob, commitment)));
  }
  return to === "bytes" ? proofs : proofs.map((x2) => bytesToHex(x2));
}

// ../monorepo/platform/node_modules/viem/_esm/utils/blob/commitmentToVersionedHash.js
init_toHex();

// ../monorepo/platform/node_modules/@noble/hashes/esm/sha256.js
init_sha2();
var sha2562 = sha256;

// ../monorepo/platform/node_modules/viem/_esm/utils/hash/sha256.js
init_isHex();
init_toBytes();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/blob/commitmentsToVersionedHashes.js
...
// ../monorepo/platform/node_modules/viem/_esm/constants/blob.js
...
// ../monorepo/platform/node_modules/viem/_esm/errors/blob.js
init_base();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/blob/toBlobs.js
init_cursor2();
init_size();
init_toBytes();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/blob/toBlobSidecars.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/transaction/getTransactionType.js
init_transaction();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/fillTransaction.js
init_parseAccount();

// ../monorepo/platform/node_modules/viem/_esm/utils/errors/getTransactionError.js
init_node();
init_transaction();
init_getNodeError();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getChainId.js
init_fromHex();
...
async function prepareTransactionRequest(client, args) {
  ...
  const fillResult = attemptFill ? await getAction(client, fillTransaction, "fillTransaction")({ ...request, nonce }).then((result) => {
    ...
    const error = e37;
    const unsupported = error.walk?.((e38) => {
      const error2 = e38;
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getContractEvents.js
init_getAbiItem();

// ../monorepo/platform/node_modules/viem/_esm/utils/abi/parseEventLogs.js
init_abi();
init_isAddressEqual();
init_toBytes();
init_keccak256();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/abi/decodeEventLog.js
init_abi();
init_cursor();
init_size();
init_toEventSelector();
...
function decodeEventLog(parameters) {
  ...
  const indexedInputs = inputs.map((x2, i21) => [x2, i21]).filter(([x2]) => "indexed" in x2 && x2.indexed);
  for (let i21 = 0; i21 < indexedInputs.length; i21++) {
    const [param, argIndex] = indexedInputs[i21];
    const topic = argTopics[i21];
    if (!topic)
  ...
  if (nonIndexedInputs.length > 0) {
    if (data && data !== "0x") {
      try {
        ...
        if (decodedData) {
          if (isUnnamed)
            for (let i21 = 0; i21 < inputs.length; i21++)
              args[i21] = args[i21] ?? decodedData.shift();
          else
            for (let i21 = 0; i21 < nonIndexedInputs.length; i21++)
              args[nonIndexedInputs[i21].name] = decodedData[i21];
        }
      } catch (err) {
        if (strict) {
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getLogs.js
init_toHex();

// ../monorepo/platform/node_modules/viem/_esm/utils/formatters/log.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/readContract.js
init_decodeFunctionResult();
init_encodeFunctionData();
init_call();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/simulateContract.js
init_parseAccount();
init_decodeFunctionResult();
init_encodeFunctionData();
init_call();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/watchContractEvent.js
init_abi();
init_rpc();

// ../monorepo/platform/node_modules/viem/_esm/utils/observe.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/wait.js
async function wait(time) {
  return new Promise((res) => setTimeout(res, time));
}

// ../monorepo/platform/node_modules/viem/_esm/utils/poll.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/promise/withCache.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getBlockNumber.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getFilterChanges.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/uninstallFilter.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/wallet/sendRawTransaction.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/promise/withRetry.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/formatters/transactionReceipt.js
init_fromHex();
var receiptStatuses = {
  "0x0": "reverted",
  "0x1": "success"
...
// ../monorepo/platform/node_modules/viem/_esm/clients/createClient.js
init_parseAccount();

// ../monorepo/platform/node_modules/viem/_esm/utils/uid.js
var size4 = 256;
var index = size4;
var buffer;
...
// ../monorepo/platform/node_modules/viem/_esm/actions/ens/getEnsAddress.js
init_abis();
init_decodeFunctionResult();
init_encodeFunctionData();
init_getChainContractAddress();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/ens/errors.js
init_base();
init_contract();
function isNullUniversalResolverError(err) {
  if (!(err instanceof BaseError2))
    return false;
  const cause = err.walk((e37) => e37 instanceof ContractFunctionRevertedError);
...
// ../monorepo/platform/node_modules/viem/_esm/utils/ens/namehash.js
init_concat();
init_toBytes();
init_toHex();
init_keccak256();

// ../monorepo/platform/node_modules/viem/_esm/utils/ens/encodedLabelToLabelhash.js
init_isHex();
...
function namehash(name) {
  ...
  for (let i21 = labels.length - 1; i21 >= 0; i21 -= 1) {
    const hashFromEncodedLabel = encodedLabelToLabelhash(labels[i21]);
    const hashed = hashFromEncodedLabel ? toBytes(hashFromEncodedLabel) : keccak256(stringToBytes(labels[i21]), "bytes");
    result = keccak256(concat([result, hashed]), "bytes");
  }
  return bytesToHex(result);
}

// ../monorepo/platform/node_modules/viem/_esm/utils/ens/packetToBytes.js
init_toBytes();

// ../monorepo/platform/node_modules/viem/_esm/utils/ens/encodeLabelhash.js
function encodeLabelhash(hash3) {
  return `[${hash3.slice(2)}]`;
}

// ../monorepo/platform/node_modules/viem/_esm/utils/ens/labelhash.js
init_toBytes();
init_toHex();
init_keccak256();
...
function packetToBytes(packet) {
  ...
  for (let i21 = 0; i21 < list.length; i21++) {
    let encoded = stringToBytes(list[i21]);
    if (encoded.byteLength > 255)
      encoded = stringToBytes(encodeLabelhash(labelhash(list[i21])));
...
// ../monorepo/platform/node_modules/viem/_esm/errors/ens.js
init_base();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/ens/avatar/utils.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/ens/avatar/parseAvatarRecord.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/ens/getEnsText.js
init_abis();
init_decodeFunctionResult();
init_encodeFunctionData();
init_getChainContractAddress();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/ens/getEnsAvatar.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/ens/getEnsName.js
init_abis();
init_getChainContractAddress();
init_localBatchGatewayRequest();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/ens/getEnsResolver.js
init_getChainContractAddress();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/clients/decorators/public.js
init_call();

// ../monorepo/platform/node_modules/viem/_esm/actions/public/createAccessList.js
init_parseAccount();
init_toHex();
init_getCallError();
init_extract();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/createBlockFilter.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/createEventFilter.js
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/createPendingTransactionFilter.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getBalance.js
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getBlobBaseFee.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getBlockTransactionCount.js
init_fromHex();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getCode.js
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/errors/eip712.js
init_base();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getEip712Domain.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getFeeHistory.js
init_toHex();

// ../monorepo/platform/node_modules/viem/_esm/utils/formatters/feeHistory.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getFilterLogs.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getProof.js
init_toHex();

// ../monorepo/platform/node_modules/viem/_esm/utils/authorization/verifyAuthorization.js
init_getAddress();
init_isAddressEqual();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/buildRequest.js
init_base();
init_request();
init_rpc();
init_toHex();

// ../monorepo/platform/node_modules/viem/_esm/utils/promise/withDedupe.js
init_lru();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/index.js
init_fromHex();
init_toHex();

// ../monorepo/platform/node_modules/viem/_esm/utils/rpc/http.js
init_request();

// ../monorepo/platform/node_modules/viem/_esm/utils/promise/withTimeout.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/rpc/id.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/signature/hashMessage.js
init_keccak256();

// ../monorepo/platform/node_modules/viem/_esm/constants/strings.js
var presignMessagePrefix = "Ethereum Signed Message:\n";

// ../monorepo/platform/node_modules/viem/_esm/utils/signature/toPrefixedMessage.js
init_concat();
init_size();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/signature/hashTypedData.js
init_encodeAbiParameters();
init_concat();
init_toHex();
init_keccak256();

// ../monorepo/platform/node_modules/viem/_esm/utils/typedData.js
init_abi();
init_address();

// ../monorepo/platform/node_modules/viem/_esm/errors/typedData.js
init_stringify();
init_base();
...
function encodeType({ primaryType, types }) {
  ...
  for (const type of deps) {
    result += `${type}(${types[type].map(({ name, type: t40 }) => `${t40} ${name}`).join(",")})`;
  }
  return result;
}
...
function encodeField({ types, name, type, value }) {
  ...
  if (type.lastIndexOf("]") === type.length - 1) {
    ...
    return [
      { type: "bytes32" },
      keccak256(encodeAbiParameters(typeValuePairs.map(([t40]) => t40), typeValuePairs.map(([, v]) => v)))
    ];
  }
  return [{ type }, value];
}

// ../monorepo/platform/node_modules/ox/_esm/erc8010/SignatureErc8010.js
...
// ../monorepo/platform/node_modules/ox/_esm/core/AbiParameters.js
init_exports();

// ../monorepo/platform/node_modules/ox/_esm/core/Address.js
init_Bytes();

// ../monorepo/platform/node_modules/ox/_esm/core/internal/lru.js
...
// ../monorepo/platform/node_modules/ox/_esm/core/Caches.js
var caches = {
...
// ../monorepo/platform/node_modules/ox/_esm/core/Hash.js
init_sha3();
init_Bytes();
init_Hex();
...
// ../monorepo/platform/node_modules/ox/_esm/core/PublicKey.js
init_Bytes();
init_Errors();
init_Hex();
init_Json();
...
function checksum2(address) {
  ...
  for (let i21 = 0; i21 < 40; i21 += 2) {
    if (hash3[i21 >> 1] >> 4 >= 8 && characters[i21]) {
      characters[i21] = characters[i21].toUpperCase();
    }
    if ((hash3[i21 >> 1] & 15) >= 8 && characters[i21 + 1]) {
      characters[i21 + 1] = characters[i21 + 1].toUpperCase();
    }
  }
...
// ../monorepo/platform/node_modules/ox/_esm/core/internal/abiParameters.js
init_Bytes();
init_Errors();
init_Hex();

// ../monorepo/platform/node_modules/ox/_esm/core/Solidity.js
var arrayRegex = /^(.*)\[([0-9]*)\]$/;
...
function prepareParameters({ checksumAddress: checksumAddress2, parameters, values }) {
  ...
  for (let i21 = 0; i21 < parameters.length; i21++) {
    preparedParameters.push(prepareParameter({
      checksumAddress: checksumAddress2,
      parameter: parameters[i21],
      value: values[i21]
    }));
  }
...
function encode3(preparedParameters) {
  let staticSize = 0;
  for (let i21 = 0; i21 < preparedParameters.length; i21++) {
    const { dynamic, encoded } = preparedParameters[i21];
    if (dynamic)
      staticSize += 32;
    else
...
function encodeString2(value) {
  ...
  const parts = [];
  for (let i21 = 0; i21 < partsLength; i21++) {
    parts.push(padRight(slice3(hexValue, i21 * 32, (i21 + 1) * 32)));
  }
  return {
    dynamic: true,
...
function encodeTuple2(value, options) {
  ...
  let dynamic = false;
  const preparedParameters = [];
  for (let i21 = 0; i21 < parameter.components.length; i21++) {
    const param_ = parameter.components[i21];
    const index2 = Array.isArray(value) ? i21 : param_.name;
    const preparedParam = prepareParameter({
      checksumAddress: checksumAddress2,
      parameter: param_,
...
// ../monorepo/platform/node_modules/ox/_esm/core/internal/cursor.js
init_Errors();
var staticCursor2 = {
  bytes: new Uint8Array(),
  dataView: new DataView(new ArrayBuffer(0)),
...
function encodePacked(types, values) {
  ...
  const data = [];
  for (let i21 = 0; i21 < types.length; i21++) {
    const type = types[i21];
    const value = values[i21];
...
(function(encodePacked2) {
  function encode6(type, value, isArray = false) {
    ...
    if (arrayMatch && Array.isArray(value)) {
      ...
      const data = [];
      for (let i21 = 0; i21 < value.length; i21++) {
        data.push(encode6(childType, value[i21], true));
      }
      if (data.length === 0)
        return "0x";
      return concat2(...data);
...
// ../monorepo/platform/node_modules/ox/_esm/core/Authorization.js
init_Hex();

// ../monorepo/platform/node_modules/ox/_esm/core/Rlp.js
init_Bytes();
init_Errors();
init_Hex();
...
// ../monorepo/platform/node_modules/ox/_esm/core/Signature.js
init_Errors();
init_Hex();
init_Json();
...
// ../monorepo/platform/node_modules/ox/_esm/core/Secp256k1.js
init_secp256k1();
init_Hex();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/formatters/proof.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getStorageAt.js
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getTransaction.js
init_transaction();
init_toHex();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getTransactionConfirmations.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/getTransactionReceipt.js
init_transaction();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/multicall.js
init_abis();
init_contracts();
init_abi();
init_base();
...
async function multicall(client, parameters) {
  ...
  for (let i21 = 0; i21 < contracts.length; i21++) {
    const { abi: abi2, address, args, functionName } = contracts[i21];
    try {
      const callData = encodeFunctionData({ abi: abi2, args, functionName });
  ...
  const results = [];
  for (let i21 = 0; i21 < aggregate3Results.length; i21++) {
    const result = aggregate3Results[i21];
    if (result.status === "rejected") {
      if (!allowFailure)
        throw result.reason;
      for (let j = 0; j < chunkedCalls[i21].length; j++) {
        results.push({
          status: "failure",
          error: result.reason,
          result: void 0
    ...
    for (let j = 0; j < aggregate3Result.length; j++) {
      ...
      const { callData } = chunkedCalls[i21][j];
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/simulateBlocks.js
init_BlockOverrides();
init_parseAccount();
init_abi();
init_contract();
...
async function simulateBlocks(client, parameters) {
  ...
  try {
    ...
    return result.map((block2, i21) => ({
      ...formatBlock(block2),
      calls: block2.calls.map((call2, j) => {
        const { abi: abi2, args, functionName, to } = blocks[i21].calls[j];
...
// ../monorepo/platform/node_modules/ox/_esm/core/AbiItem.js
init_exports();
init_Errors();
init_Hex();

// ../monorepo/platform/node_modules/ox/_esm/core/internal/abiItem.js
init_Errors();
  ...
  switch (abiParameterType) {
    ...
    default: {
      ...
      if (/^bytes([1-9]|1[0-9]|2[0-9]|3[0-2])?$/.test(abiParameterType))
        return argType === "string" || arg instanceof Uint8Array;
      if (/[a-z]+[1-9]{0,3}(\[[0-9]{0,}\])+$/.test(abiParameterType)) {
        return Array.isArray(arg) && arg.every((x2) => isArgOfType2(x2, {
          ...abiParameter,
          // Pop off `[]` or `[M]` from end of type
          type: abiParameterType.replace(/(\[[0-9]{0,}\])$/, "")
        }));
  ...
  constructor(x2, y2) {
    super("Found ambiguous types in overloaded ABI Items.", {
      metaMessages: [
        ...
        `\`${x2.type}\` in \`${normalizeSignature2(formatAbiItem(x2.abiItem))}\`, and`,
...
// ../monorepo/platform/node_modules/ox/_esm/core/AbiConstructor.js
init_Hex();
...
// ../monorepo/platform/node_modules/ox/_esm/core/AbiFunction.js
init_Hex();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/simulateCalls.js
init_parseAccount();

// ../monorepo/platform/node_modules/viem/_esm/constants/address.js
...
async function simulateCalls(client, parameters) {
  ...
  const blocks = await simulateBlocks(client, {
    ...
    blocks: [
      ...traceAssetChanges ? [
        ...
        // Asset pre balances
        {
          calls: assetAddresses.map((address, i21) => ({
            abi: [
  ...
  const changes = [];
  for (const [i21, balancePost] of balancesPost.entries()) {
    const balancePre = balancesPre[i21];
    if (typeof balancePost !== "bigint")
      continue;
    if (typeof balancePre !== "bigint")
      continue;
    const decimals_ = decimals[i21 - 1];
    const symbol_ = symbols[i21 - 1];
    const tokenURI_ = tokenURI[i21 - 1];
    const token = (() => {
      if (i21 === 0)
        return {
          address: ethAddress,
...
// ../monorepo/platform/node_modules/ox/_esm/erc6492/SignatureErc6492.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/verifyHash.js
init_abis();
init_contracts();
init_contract();
init_encodeDeployData();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/signature/serializeSignature.js
init_secp256k1();
init_fromHex();
init_toBytes();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/verifyMessage.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/verifyTypedData.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/waitForTransactionReceipt.js
init_transaction();
init_withResolvers();
init_stringify();

// ../monorepo/platform/node_modules/viem/_esm/actions/public/watchBlockNumber.js
init_fromHex();
init_stringify();
      ...
      try {
        ...
        if (prevBlockNumber !== void 0) {
          ...
          if (blockNumber - prevBlockNumber > 1 && emitMissed) {
            for (let i21 = prevBlockNumber + 1n; i21 < blockNumber; i21++) {
              emit.onBlockNumber(i21, prevBlockNumber);
              prevBlockNumber = i21;
            }
          }
        }
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/watchBlocks.js
init_stringify();
      ...
      try {
        ...
        if (block.number !== null && prevBlock?.number != null) {
          ...
          if (block.number - prevBlock.number > 1 && emitMissed) {
            for (let i21 = prevBlock?.number + 1n; i21 < block.number; i21++) {
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/watchEvent.js
init_abi();
init_rpc();
init_stringify();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/public/watchPendingTransactions.js
init_stringify();
...
// ../monorepo/platform/node_modules/viem/_esm/utils/siwe/parseSiweMessage.js
...
// ../monorepo/platform/node_modules/viem/_esm/utils/siwe/validateSiweMessage.js
init_isAddress();
init_isAddressEqual();
...
// ../monorepo/platform/node_modules/viem/_esm/actions/siwe/verifySiweMessage.js
...
// ../monorepo/platform/node_modules/viem/_esm/actions/wallet/sendRawTransactionSync.js
init_transaction();
...
// ../monorepo/platform/node_modules/viem/_esm/clients/createPublicClient.js
...
// ../monorepo/platform/node_modules/viem/_esm/clients/transports/createTransport.js
...
// ../monorepo/platform/node_modules/viem/_esm/clients/transports/http.js
init_request();

// ../monorepo/platform/node_modules/viem/_esm/errors/transport.js
init_base();
...
// ../monorepo/platform/node_modules/viem/_esm/index.js
init_isHex();
init_toHex();

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/utils/index.mjs
var p11 = (p13, i21, c4, s11) => {
  let l8 = Number(p13), n8 = i21.find(((r20) => r20.id === l8));
  if (!n8) throw new i9(`Unsupported chainId ${p13}`, 4901);
  return createPublicClient({ transport: http(o10(n8, c4, s11.appId)), chain: n8 });
};
var o10 = (r20, e37, p13) => {
  let o19, i21 = r20.id, c4 = Number(r20.id);
  if (r20.rpcUrls.privyWalletOverride && r20.rpcUrls.privyWalletOverride.http[0]) o19 = r20.rpcUrls.privyWalletOverride.http[0];
  else if (e37.rpcUrls && e37.rpcUrls[c4]) o19 = e37.rpcUrls[c4];
  else if (r20.rpcUrls.privy?.http[0]) {
    let e38 = new URL(r20.rpcUrls.privy.http[0]);
    e38.searchParams.append("privyAppId", p13), o19 = e38.toString();
  } else o19 = r20.rpcUrls.public?.http[0] ? r20.rpcUrls.public.http[0] : r20.rpcUrls.default?.http[0];
  if (!o19) throw new i9(`No RPC url found for ${i21}`);
  return o19;
};
function i10({ currentRecoveryMethod: r20, upgradeToRecoveryMethod: e37 }) {
  switch (r20) {
    case "privy":
    case "user-passcode":
    ...
    case "icloud":
    case "google-drive":
      if (r20 === e37) throw Error("Cannot upgrade to the existing cloud platform");
      return true;
    default:
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/sleep.mjs
function e26(e37) {
  return new Promise(((t40) => {
    setTimeout((() => {
      t40();
    }), e37);
  }));
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/EventCallbackQueue.mjs
var e27 = class {
  enqueue(e37, a20) {
    this.callbacks[e37] = a20;
  }
  dequeue(e37, a20) {
    let r20 = this.callbacks[a20];
    if (!r20) throw Error(`cannot dequeue ${e37} event: no event found for id ${a20}`);
    switch (delete this.callbacks[a20], e37) {
      ...
      case "privy:mfa:clear":
        return r20;
      default:
        throw Error(`invalid wallet event type ${e37}`);
    }
  }
  constructor() {
    this.callbacks = {};
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/withMfa.mjs
async function r10(r20, t40, i21, a20, n8 = false, o19, c4) {
  let m3 = n8, s11 = async (o20) => {
    if (m3) {
      o20 === (n8 ? 0 : 1) ? a20() : i21.current?.reject(new o9("missing_or_invalid_mfa", "MFA verification failed, retry."));
      let m4 = await new Promise(((r21, a21) => {
        t40.current = { resolve: r21, reject: a21 }, setTimeout((() => {
          let r22 = new o9("mfa_timeout", "Timed out waiting for MFA code");
          i21.current?.reject(r22), a21(r22);
        }), c4);
      }));
      return await r20(m4);
    }
  ...
  for (let e37 = 0; e37 < o19; e37++) try {
    f2 = await s11(e37), i21.current?.resolve(void 0);
    break;
  } catch (e38) {
    if ("missing_or_invalid_mfa" !== e38.type) throw i21.current?.resolve(void 0), e38;
    m3 = true;
  }
  if (null === f2) {
    let r21 = new o9("mfa_verification_max_attempts_reached", "Max MFA verification attempts reached");
    throw i21.current?.reject(r21), r21;
  }
  return f2;
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/EmbeddedWalletProxy.mjs
var a16;
var s7 = (a16 = 0, () => "id-" + a16++);
var n2 = (e37, t40) => "bigint" == typeof t40 ? t40.toString() : t40;
var l2 = async (e37, { ms: t40, msg: i21 }) => {
  let r20, a20 = new Promise(((e38, a21) => {
    r20 = setTimeout((() => {
      a21(Error(i21));
    }), t40 ?? 15e3);
  }));
  try {
    return await Promise.race([e37, a20]);
  } finally {
...
var m = new e27();
var h8 = class {
  invokeWithMfa(e37, t40) {
    return l2(r10(((i21) => l2(this.waitForReady().then((() => e37(i21))), { msg: t40.timeoutMsg, ms: t40.timeoutMs })), this.mfa.rootPromise, this.mfa.submitPromise, (() => this.mfa.emit("mfaRequired")), t40.mfaAlwaysRequired ?? false, 4, 3e5), { msg: "Operation reached timeout: MFA verification", ms: 126e4 });
  }
  reload() {
    return this.ready = false, this._embeddedWalletMessagePoster.reload();
  }
  ping(e37 = 15e3) {
    return l2(this.invoke("privy:iframe:ready", {}), { msg: "Ping reached timeout", ms: e37 });
  }
  create(e37) {
    return l2(this.waitForReady().then((() => this.invoke("privy:wallet:create", e37))), { msg: "Operation reached timeout: create" });
  }
  rpc(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:wallet:rpc", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: rpc" });
  }
  createSolana(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:solana-wallet:create", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: create", timeoutMs: 6e4 });
  }
  createAdditionalSolana(e37) {
    return l2(this.waitForReady().then((() => this.invoke("privy:solana-wallet:create-additional", e37))), { msg: "Operation reached timeout: create" });
  }
  solanaRpc(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:solana-wallet:rpc", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: solana-rpc" });
  }
  delegateWallets(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:delegated-actions:consent", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: delegated-actions:consent" });
  }
  verifyMfa(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:mfa:verify", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: mfa:verify", mfaAlwaysRequired: true });
  }
  initEnrollMfa(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:mfa:init-enrollment", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: mfa:init-enrollment" });
  }
  submitEnrollMfa(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:mfa:submit-enrollment", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: mfa:submit-enrollment" });
  }
  unenrollMfa(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:mfa:unenroll", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: mfa:unenroll", mfaAlwaysRequired: true });
  }
  clearMfa(e37) {
    return l2(this.waitForReady().then((() => this.invoke("privy:mfa:clear", e37))), { msg: "Operation reached timeout: mfa:clear" });
  }
  createWallet(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:wallets:create", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: create", timeoutMs: 6e4 });
  }
  signWithUserSigner(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:user-signer:sign", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: user-signer:sign" });
  }
  addWallet(e37) {
    return l2(this.waitForReady().then((() => this.invoke("privy:wallets:add", e37))), { msg: "Operation reached timeout: wallets:add" });
  }
  setRecovery(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:wallets:set-recovery", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: wallets:set-recovery", timeoutMs: 6e4 });
  }
  connect(e37) {
    return l2(this.waitForReady().then((() => this.invoke("privy:wallets:connect", e37))), { msg: "Operation reached timeout: wallets:connect" });
  }
  recover(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:wallets:recover", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: wallets:recover", timeoutMs: 6e4 });
  }
  rpcWallet(e37) {
    return this.invokeWithMfa(((t40) => this.invoke("privy:wallets:rpc", { ...t40, ...e37 })), { timeoutMsg: "Operation reached timeout: wallets:rpc" });
  }
  handleEmbeddedWalletMessages(e37) {
    if (!e37.event.startsWith("privy:")) return void console.warn(`Unsupported event type: ${e37.event}`);
    let { reject: t40, resolve: r20 } = m.dequeue(e37.event, e37.id);
    return void 0 !== e37.error ? t40(new o9(e37.error.type, e37.error.message)) : r20(e37.data);
  }
  waitForReady() {
    return this.ready ? Promise.resolve() : new Promise((async (t40, i21) => {
      for (; !this.ready; ) this.invoke("privy:iframe:ready", {}).then((() => {
        this.ready = true, t40();
      })).catch(i21), await e26(150);
    }));
  }
  invoke(e37, t40) {
    let i21 = ((e38, t41) => `${e38}${JSON.stringify(t41, n2)}`)(e37, t40);
    if ("privy:wallet:create" === e37 || "privy:solana-wallet:create" === e37) {
      let e38 = this.cache.get(i21);
      if (e38) return e38;
    }
    let r20 = new Promise(((i22, r21) => {
      let a20 = s7();
      m.enqueue(a20, { resolve: i22, reject: r21 }), this._embeddedWalletMessagePoster.postMessage(JSON.stringify({ id: a20, event: e37, data: t40 }), "*");
    })).finally((() => {
      this.cache.delete(i21);
    }));
    return this.cache.set(i21, r20), r20;
  }
  constructor(e37, t40) {
    this.ready = false, this.cache = /* @__PURE__ */ new Map(), this._embeddedWalletMessagePoster = e37, this.mfa = t40;
  }
};

// ../monorepo/platform/node_modules/eventemitter3/index.mjs
var import_index = __toESM(require_eventemitter3(), 1);
var eventemitter3_default = import_index.default;

// ../monorepo/platform/node_modules/@privy-io/ethereum/dist/esm/to-viem-transaction-serializable.mjs
var r11 = { 0: "legacy", 1: "eip2930", 2: "eip1559", 3: "eip4844", 4: "eip7702" };
var i11 = { legacy: 0, eip2930: 1, eip1559: 2, eip4844: 3, eip7702: 4 };
var s8 = (e37) => void 0 !== e37 ? BigInt(e37) : void 0;
function t28(i21) {
  let t40, { type: c4 = 2, ...o19 } = "string" == typeof i21 ? JSON.parse(i21) : i21;
  o19.accessList && Array.isArray(o19.accessList) ? t40 = o19.accessList.map(((e37) => Array.isArray(e37) ? { address: e37[0], storageKeys: e37[1] } : e37)) : o19.accessList && (t40 = Object.entries(o19.accessList).map(((e37) => ({ address: e37[0], storageKeys: e37[1] }))));
  let d7 = Number(o19.chainId ?? 1), n8 = isHex(o19.data) ? o19.data : o19.data ? toHex(Uint8Array.from(o19.data)) : void 0, p13 = o19.nonce ? Number(o19.nonce) : void 0, m3 = { chainId: d7, data: n8, nonce: p13, value: s8(o19.value), gas: s8(o19.gas ?? o19.gasLimit) }, y2 = Number(c4);
  if (0 === y2) return { ...o19, type: r11[y2], ...m3, gasPrice: s8(o19.gasPrice), accessList: void 0, maxFeePerGas: void 0, maxPriorityFeePerGas: void 0 };
  if (1 === y2) return { ...o19, type: r11[y2], ...m3, gasPrice: s8(o19.gasPrice), accessList: t40, maxFeePerGas: void 0, maxPriorityFeePerGas: void 0 };
  if (2 === y2) return { ...o19, type: r11[y2], ...m3, nonce: p13, accessList: t40, maxFeePerGas: s8(o19.maxFeePerGas), maxPriorityFeePerGas: s8(o19.maxPriorityFeePerGas), gasPrice: void 0, maxFeePerBlobGas: void 0 };
  throw Error(`Unsupported transaction type: ${c4}`);
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/encodings.mjs
var t29 = (t40) => /^0x[0-9a-fA-F]*$/.test(t40);
var f = (t40) => Buffer.from(t40, "utf8");
var e28 = (t40) => `0x${t40.toString("hex")}`;

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/wallet-api/generate-authorization-signature.mjs
var import_canonicalize = __toESM(require_canonicalize(), 1);
async function i12(i21, o19) {
  let t40 = (0, import_canonicalize.default)(o19);
  if (void 0 === t40) throw new e24({ error: "Failed to prepare the payload for signing", code: "invalid_input" });
  let a20 = Buffer.from(t40).toString("base64"), { signature: n8 } = await i21({ message: a20 });
  return { signature: n8 };
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/wallet-api/rpc.mjs
var import_canonicalize2 = __toESM(require_canonicalize(), 1);
async function t30(t40, i21, { wallet_id: e37, ...o19 }) {
  let p13 = { version: 1, url: t40.getCompiledPath(p9, { params: { wallet_id: e37 } }), method: p9.method, headers: { "privy-app-id": t40.app.appId }, body: { ...o19 } }, { signature: m3 } = await i12(i21, p13);
  return await t40.fetchPrivyRoute(p9, { body: o19, params: { wallet_id: e37 }, headers: { "privy-authorization-signature": m3 } });
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/stack/wallet-api-eth-transaction.mjs
function t31(t40) {
  return { from: t40.from, to: t40.to ?? void 0, nonce: n3(t40.nonce), chain_id: n3(t40.chainId), data: (function(t41) {
    if (void 0 !== t41) return "string" == typeof t41 ? t29(t41) ? t41 : e28(f(t41)) : e28(Buffer.from(Uint8Array.from(t41)));
  })(t40.data), value: n3(t40.value), type: t40.type, gas_limit: n3(t40.gasLimit), gas_price: n3(t40.gasPrice), max_fee_per_gas: n3(t40.maxFeePerGas), max_priority_fee_per_gas: n3(t40.maxPriorityFeePerGas) };
}
function n3(t40) {
  if ("number" == typeof t40 || "bigint" == typeof t40) {
    return `0x${BigInt(t40).toString(16)}`;
  }
  if ("string" == typeof t40) return t29(t40) ? t40 : e28(f(t40));
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/stack/wallet-api-eth-typed-data.mjs
function e29(e37) {
  return "string" == typeof e37 && (e37 = JSON.parse(e37)), { types: e37.types, primary_type: String(e37.primaryType), domain: e37.domain, message: e37.message };
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/stack/walletRpc.mjs
var import_canonicalize3 = __toESM(require_canonicalize(), 1);
async function i13({ context: i21, account: o19, rpcRequest: c4 }) {
  switch (c4.chainType) {
    case "ethereum":
      return (async function({ context: i22, account: o20, rpcRequest: c5 }) {
        switch (c5.method) {
          case "personal_sign": {
            let [e37] = c5.params, t40 = await t30(i22, i22.signRequest, { chain_type: "ethereum", method: "personal_sign", wallet_id: o20.id, params: e37.startsWith("0x") ? { message: e37.slice(2), encoding: "hex" } : { message: e37, encoding: "utf-8" } });
            if ("personal_sign" !== t40.method) throw Error("Unable to sign message");
            return { data: t40.data.signature };
          }
          case "eth_signTransaction": {
            let [e37] = c5.params, t40 = await t30(i22, i22.signRequest, { chain_type: "ethereum", method: "eth_signTransaction", wallet_id: o20.id, params: { transaction: t31(e37) } });
            if ("eth_signTransaction" !== t40.method) throw Error("Unable to sign transaction");
            return { data: t40.data.signed_transaction };
          }
          case "eth_signTypedData_v4": {
            let [, e37] = c5.params, t40 = await t30(i22, i22.signRequest, { chain_type: "ethereum", method: c5.method, wallet_id: o20.id, params: { typed_data: e29(e37) } });
            if ("eth_signTypedData_v4" !== t40.method) throw Error("Unable to sign typed data");
            return { data: t40.data.signature };
          }
          case "eth_sign": {
            let [, n8] = c5.params, r20 = await t30(i22, i22.signRequest, { chain_type: "ethereum", method: "secp256k1_sign", wallet_id: o20.id, params: { hash: t29(n8) ? n8 : e28(f(n8)) } });
            if ("secp256k1_sign" !== r20.method) throw Error("Unable to sign message");
            return { data: r20.data.signature };
          }
          case "secp256k1_sign": {
            let [n8] = c5.params, r20 = await t30(i22, i22.signRequest, { chain_type: "ethereum", method: "secp256k1_sign", wallet_id: o20.id, params: { hash: t29(n8) ? n8 : e28(f(n8)) } });
            if ("secp256k1_sign" !== r20.method) throw Error("Unable to sign message");
      ...
      })({ context: i21, account: o19, rpcRequest: c4.request });
    case "solana":
      return (async function({ context: e37, account: t40, rpcRequest: a20 }) {
        if ("signMessage" === a20.method) {
          let { message: n8 } = a20.params, r20 = await t30(e37, e37.signRequest, { chain_type: "solana", method: "signMessage", wallet_id: t40.id, params: { message: n8, encoding: "base64" } });
          if ("signMessage" !== r20.method) throw Error("Unable to sign message");
          return { data: r20.data.signature };
        }
      })({ context: i21, account: o19, rpcRequest: c4.request });
  }
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/EmbeddedWalletProvider.mjs
...
var l3 = class extends eventemitter3_default {
  async request(e37) {
    if (d3.has(e37.method)) return this.handleIFrameRpc(e37);
    switch (e37.method) {
      case "eth_accounts":
      ...
      case "wallet_switchEthereumChain":
        return this.handleSwitchEthereumChain(e37);
      case "eth_estimateGas":
        return this.handleEstimateGas(e37);
      case "eth_signTransaction": {
        let t40 = e37.params?.[0];
        return this.handleSignTransaction(t40);
      }
      case "eth_sendTransaction": {
        let t40 = e37.params?.[0];
        return this.handleSendTransaction(t40);
      }
      case "eth_populateTransactionRequest": {
        let t40 = e37.params?.[0];
        return this.handlePopulateTransaction(t40);
      }
      default:
        return this.handleJsonRpc(e37);
    }
  }
  ensureChainId(e37) {
    let t40 = { chainId: this._chainId, ...e37 };
    return this.internalSwitchEthereumChain(t40.chainId), t40;
  }
  internalSwitchEthereumChain(e37) {
    e37 && Number(e37) !== this._chainId && (this._chainId = Number(e37), this._client = p11(this._chainId, this._chains, { rpcUrls: [] }, { appId: this._privyInternal.appId }), this.emit("chainChanged", e37));
  }
  async handlePopulateTransaction(e37) {
    let t40 = this.ensureChainId(e37), i21 = t28(t40), { type: s11, ...n8 } = await this._client.prepareTransactionRequest({ account: t40.from ?? this._account.address, ...i21 });
    return { ...n8, type: i11[s11] };
  }
  async handleSignTransaction(e37) {
    let r20 = { ...e37 };
    for (let e38 of Object.keys(r20)) {
      let a20 = r20[e38];
      a20 && "bigint" == typeof a20 && (r20[e38] = toHex(a20));
    }
    return await this.handleIFrameRpc({ method: "eth_signTransaction", params: [r20] });
  }
  async handleSendTransaction(e37) {
    let t40 = await this.handlePopulateTransaction(e37), r20 = await this.handleSignTransaction(t40);
    return await this.handleJsonRpc({ method: "eth_sendRawTransaction", params: [r20] });
  }
  async handleEstimateGas(e37) {
    if (!e37.params || !Array.isArray(e37.params)) throw Error("Invalid params for eth_estimateGas");
    let t40 = e37.params?.[0], a20 = this.ensureChainId(t40), i21 = t28(a20);
    return await this._client.estimateGas({ account: a20.from ?? this._account.address, ...i21 });
  }
  handleSwitchEthereumChain(e37) {
    let t40;
    if (!e37.params || !Array.isArray(e37.params)) throw new d2(`Invalid params for ${e37.method}`, 4200);
    if ("string" == typeof e37.params[0]) t40 = e37.params[0];
    else {
      if (!("chainId" in e37.params[0]) || "string" != typeof e37.params[0].chainId) throw new d2(`Invalid params for ${e37.method}`, 4200);
      t40 = e37.params[0].chainId;
    }
    this.internalSwitchEthereumChain(t40);
  }
  async handleIFrameRpc(e37) {
    try {
      let t40 = await this._privyInternal.getAccessTokenInternal();
      if (!t40) throw Error("Missing privy token. User must be logged in");
      this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_rpc_started", { method: e37.method, address: this._account.address });
      let r20 = this._account;
      if (e25(r20)) {
        let { data: a20 } = await i13({ context: { app: this._appApi, fetchPrivyRoute: (...e38) => this._privyInternal.fetch(...e38), getCompiledPath: (...e38) => this._privyInternal.getPath(...e38), signRequest: ({ message: e38 }) => this._walletProxy.signWithUserSigner({ accessToken: t40, message: e38 }) }, account: r20, rpcRequest: { chainType: "ethereum", request: e37 } });
        return a20;
      }
      try {
        await this._walletProxy.connect({ entropyId: this._entropyId, entropyIdVerifier: this._entropyIdVerifier, accessToken: t40 });
      } catch (e38) {
        let r21 = E(e38);
        if (r21 && "privy" === this._account.recovery_method) await this._walletProxy.recover({ entropyId: this._entropyId, entropyIdVerifier: this._entropyIdVerifier, accessToken: t40 });
        else {
          if (!r21 || !this._onNeedsRecovery) throw e38;
          {
            let e39;
            await new Promise((async (t41, r22) => {
              e39 = setTimeout((() => r22(new e24({ code: "embedded_wallet_recovery_error", error: "User-owned recovery timed out" }))), 12e4), await this._onNeedsRecovery?.({ recoveryMethod: this._account.recovery_method, onRecovered: () => t41(true) });
            })).finally((() => clearTimeout(e39)));
          }
        }
      }
      return (await this._walletProxy.rpcWallet({ accessToken: t40, request: e37, entropyId: this._entropyId, entropyIdVerifier: this._entropyIdVerifier, hdWalletIndex: this._account.wallet_index, chainType: "ethereum" })).response.data;
    } catch (t40) {
      console.error(t40);
      let r20 = t40 instanceof Error ? t40.message : "Unable to make wallet request";
      throw this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_rpc_failed", { method: e37.method, address: this._account.address, error: r20 }), new e24({ code: "embedded_wallet_request_error", error: r20 });
    }
  }
  async handleJsonRpc(e37) {
    return this._client.request(e37);
  }
  toJSON() {
    return `PrivyEIP1193Provider { address: '${this._account.address}', chainId: ${this._chainId}, request: [Function] }`;
  }
  constructor({ walletProxy: e37, privyInternal: t40, account: r20, entropyId: a20, entropyIdVerifier: i21, chains: s11, onNeedsRecovery: n8, chainId: o19 = s11[0].id, appApi: h10 }) {
    super(), this._walletProxy = e37, this._privyInternal = t40, this._account = r20, this._entropyId = a20, this._entropyIdVerifier = i21, this._chainId = o19, this._chains = s11, this._onNeedsRecovery = n8, this._client = p11(o19, s11, { rpcUrls: [] }, { appId: h10.appId }), this._appApi = h10;
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/solana/isVersionedTransaction.mjs
function n4(n8) {
  return "version" in n8;
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/solana/getWalletPublicKeyFromTransaction.mjs
function e30(e37, t40) {
  let n8 = (n4(e37) ? e37.message : e37.compileMessage()).staticAccountKeys.find(((o19) => o19.toBase58() === t40));
  if (!n8) throw Error(`Transaction does not contain public key ${t40}`);
  return n8;
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/embedded/EmbeddedSolanaWalletProvider.mjs
...
var i14 = class {
  async request(t40) {
    ...
    switch (t40.method) {
      case "signAndSendTransaction":
        return await this.handleSignAndSendTransaction(t40);
      case "signTransaction":
        return await this.handleSignTransaction(t40);
      default:
        return await this.handleIFrameRpc(t40);
    }
  }
  get _publicKey() {
    return this._account.address;
  }
  async connectAndRecover(t40) {
    if ("privy-v2" !== this._account.recovery_method) try {
      await this._proxy.connect({ entropyId: this._entropyId, entropyIdVerifier: this._entropyIdVerifier, accessToken: t40 });
    } catch (r20) {
      let a20 = E(r20);
      if (a20 && "privy" === this._account.recovery_method) await this._proxy.recover({ entropyId: this._entropyId, entropyIdVerifier: this._entropyIdVerifier, accessToken: t40 });
      else {
        if (!a20 || !this._onNeedsRecovery) throw r20;
        {
          let t41;
          await new Promise((async (r21, a21) => {
            t41 = setTimeout((() => a21(new e24({ code: "embedded_wallet_recovery_error", error: "User-owned recovery timed out" }))), 12e4), await this._onNeedsRecovery?.({ recoveryMethod: this._account.recovery_method, onRecovered: () => r21(true) });
          })).finally((() => clearTimeout(t41)));
        }
      }
    }
  }
  async signMessageRpc(e37, t40) {
    let r20 = this._account;
    if (!e25(r20)) return (await this._proxy.rpcWallet({ accessToken: t40, request: e37, chainType: "solana", hdWalletIndex: this._account.wallet_index, entropyId: this._entropyId, entropyIdVerifier: this._entropyIdVerifier })).response.data;
    {
      let { data: a20 } = await i13({ context: { app: this._app, fetchPrivyRoute: (...e38) => this._privyInternal.fetch(...e38), getCompiledPath: (...e38) => this._privyInternal.getPath(...e38), signRequest: ({ message: e38 }) => this._proxy.signWithUserSigner({ accessToken: t40, message: e38 }) }, account: r20, rpcRequest: { chainType: "solana", request: e37 } });
  ...
  async handleIFrameRpc(t40) {
    try {
      let e37 = await this._privyInternal.getAccessTokenInternal();
      if (!e37) throw Error("Missing privy token. User must be logged in");
      return this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_rpc_started", { method: t40.method, address: this._account.address }), await this.connectAndRecover(e37), await this.signMessageRpc(t40, e37);
    } catch (r20) {
      console.error(r20);
      let a20 = r20 instanceof Error ? r20.message : "Unable to make wallet request";
      throw this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_rpc_failed", { method: t40.method, address: this._account.address, error: a20 }), new e24({ code: "embedded_wallet_request_error", error: a20 });
    }
  }
  async handleSignAndSendTransaction(a20) {
    try {
      let e37 = await this._privyInternal.getAccessTokenInternal();
      if (!e37) throw Error("Missing privy token. User must be logged in");
      this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_rpc_started", { method: a20.method, address: this._account.address }), await this.connectAndRecover(e37);
      let { transaction: s11, connection: n8, options: i21 } = a20.params, o19 = e30(s11, this._account.address), c4 = n4(s11) ? Buffer.from(s11.message.serialize()) : s11.serializeMessage(), { signature: d7 } = await this.signMessageRpc({ method: "signMessage", params: { message: c4.toString("base64") } }, e37);
      return s11.addSignature(o19, Buffer.from(d7, "base64")), { signature: await n8.sendRawTransaction(s11.serialize(), i21) };
    } catch (t40) {
      console.error(t40);
      let r20 = t40 instanceof Error ? t40.message : "Unable to make wallet request";
  ...
  async handleSignTransaction(a20) {
    try {
      ...
      if (!e37) throw Error("Missing privy token. User must be logged in");
      this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_rpc_started", { method: a20.method, address: this._account.address }), await this.connectAndRecover(e37);
      let { transaction: s11 } = a20.params, n8 = e30(s11, this._account.address), i21 = n4(s11) ? Buffer.from(s11.message.serialize()) : s11.serializeMessage(), { signature: o19 } = await this.signMessageRpc({ method: "signMessage", params: { message: i21.toString("base64") } }, e37);
      return s11.addSignature(n8, Buffer.from(o19, "base64")), { signedTransaction: s11 };
    } catch (t40) {
      console.error(t40);
      let r20 = t40 instanceof Error ? t40.message : "Unable to make wallet request";
  ...
  constructor({ proxy: e37, privyInternal: t40, account: r20, entropyId: a20, entropyIdVerifier: s11, onNeedsRecovery: n8, app: i21 }) {
    this._proxy = e37, this._privyInternal = t40, this._account = r20, this._entropyId = a20, this._entropyIdVerifier = s11, this._onNeedsRecovery = n8, this._app = i21;
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/EmbeddedWalletApi.mjs
var import_canonicalize6 = __toESM(require_canonicalize(), 1);
var y = class {
  setMessagePoster(e37) {
    this._proxy = new h8(e37, this._mfaPromises), this._mfa.setProxy(this._proxy);
  }
  async signWithUserSigner(e37) {
    ...
    let { signature: o19 } = await this._proxy.signWithUserSigner({ accessToken: r20, message: e37.message });
    return { signature: o19 };
  }
  async add(e37) {
    if (!this._proxy) throw Error("Embedded wallet proxy not initialized");
    if ("user-controlled-server-wallets-only" === this._privyInternal.config?.embedded_wallet_config.mode) await t27({ context: { app: this._appApi, fetchPrivyRoute: (...e38) => this._privyInternal.fetch(...e38), getCompiledPath: (...e38) => this._privyInternal.getPath(...e38) }, chainType: e37.chainType });
    else {
      ...
      await this._proxy.addWallet({ accessToken: r21, ...e37 });
    }
    let { user: r20 } = await this._privyInternal.refreshSession();
    return { user: r20 };
  }
  async getBitcoinProvider({ wallet: e37, entropyId: r20, entropyIdVerifier: t40, recoveryPassword: i21, recoveryAccessToken: d7, recoverySecretOverride: a20 }) {
    if (!this._proxy) throw Error("Embedded wallet proxy not initialized");
    if (!await this._privyInternal.getAccessTokenInternal()) throw Error("User must be logged in to create an embedded wallet");
    return e25(e37) || await this._load({ entropyId: r20, entropyIdVerifier: t40, wallet: e37, recoveryPassword: i21, recoveryAccessToken: d7, recoverySecretOverride: a20 }), new r7({ account: e37, privyInternal: this._privyInternal, proxy: this._proxy, entropyId: r20, entropyIdVerifier: t40 });
  }
  async create({ password: e37, recoveryMethod: r20, recoveryToken: o19, recoveryKey: i21, recoverySecretOverride: a20, iCloudRecordNameOverride: s11, solanaAccount: n8, skipCallbacks: c4, idempotencyKey: l8 }) {
    if (!this._proxy) throw Error("Embedded wallet proxy not initialized");
    if ("user-controlled-server-wallets-only" === this._privyInternal.config?.embedded_wallet_config.mode) {
      ...
      await t27({ context: { app: this._appApi, fetchPrivyRoute: (...e38) => this._privyInternal.fetch(...e38), getCompiledPath: (...e38) => this._privyInternal.getPath(...e38) }, chainType: "ethereum", idempotencyKey: l8 });
    } else {
      let t40;
      if (t40 = r20 || (e37 ? "user-passcode" : "privy"), e37 && "string" != typeof e37) throw Error("Invalid recovery password, must be a string");
      if ("privy" === t40 && this._privyInternal.config?.embedded_wallet_config.require_user_password_on_create) throw Error("Password not provided yet is required by App configuration");
      ...
      let { address: c5 } = await this._proxy.create({ accessToken: d7, recoveryMethod: t40, recoveryKey: i21, recoveryPassword: e37, recoveryAccessToken: o19, recoverySecretOverride: a20, iCloudRecordNameOverride: s11, solanaAddress: n8?.address });
      if (!c5) throw Error("Failed to create wallet");
    }
    return await this._privyInternal.refreshSession(c4);
  }
  async createSolana(e37) {
    if (!this._proxy) throw new e24({ error: "Embedded wallet proxy not initialized", code: "embedded_wallet_creation_error" });
    if ("user-controlled-server-wallets-only" === this._privyInternal.config?.embedded_wallet_config.mode) await t27({ context: { app: this._appApi, fetchPrivyRoute: (...e38) => this._privyInternal.fetch(...e38), getCompiledPath: (...e38) => this._privyInternal.getPath(...e38) }, chainType: "solana", idempotencyKey: e37?.idempotencyKey });
    else {
      let r20 = await this._privyInternal.getAccessTokenInternal();
      if (!r20) throw new e24({ error: "User must be logged in to create an embedded wallet", code: "embedded_wallet_creation_error" });
      e37?.ethereumAccount && await this.getProvider(e37.ethereumAccount);
      let { publicKey: o19 } = await this._proxy.createSolana({ accessToken: r20, ethereumAddress: e37?.ethereumAccount?.address });
      if (!o19) throw new e24({ error: "Failed to create wallet", code: "embedded_wallet_creation_error" });
    }
    return await this._privyInternal.refreshSession();
  }
  async delegateWallets({ delegatedWallets: e37, rootWallet: r20 }) {
    if (!this._proxy) throw new e24({ error: "Embedded wallet proxy not initialized", code: "embedded_wallet_creation_error" });
    let o19 = await this._privyInternal.getAccessTokenInternal();
    if (!o19) throw new e24({ error: "User must be logged in to create an embedded wallet", code: "embedded_wallet_creation_error" });
    await this._proxy.delegateWallets({ accessToken: o19, delegatedWallets: e37, rootWallet: r20 });
  }
  async getProvider(e37, r20, t40, o19, i21) {
    if (!this._proxy) throw Error("Embedded wallet proxy not initialized");
    return e25(e37) || await this._load({ wallet: e37, entropyId: e37.address, entropyIdVerifier: "ethereum-address-verifier", recoveryPassword: r20, recoveryKey: i21, recoveryAccessToken: t40, recoverySecretOverride: o19 }), new l3({ account: e37, entropyId: e37.address, entropyIdVerifier: "ethereum-address-verifier", privyInternal: this._privyInternal, chains: this._chains, walletProxy: this._proxy, appApi: this._appApi });
  }
  async getEthereumProvider({ wallet: e37, entropyId: r20, entropyIdVerifier: t40, recoveryPassword: o19, recoveryAccessToken: i21, recoverySecretOverride: d7, recoveryKey: a20, onNeedsRecovery: n8 }) {
    if (!this._proxy) throw Error("Embedded wallet proxy not initialized");
    if (!await this._privyInternal.getAccessTokenInternal()) throw Error("User must be logged in to create an embedded wallet");
    return e25(e37) || (!n8 || o19 || i21 || d7 || a20) && await this._load({ entropyId: r20, entropyIdVerifier: t40, wallet: e37, recoveryPassword: o19, recoveryAccessToken: i21, recoverySecretOverride: d7, recoveryKey: a20 }), new l3({ account: e37, entropyId: r20, entropyIdVerifier: "ethereum-address-verifier", privyInternal: this._privyInternal, chains: this._chains, walletProxy: this._proxy, onNeedsRecovery: n8, appApi: this._appApi });
  }
  async getSolanaProvider(e37, r20, o19, i21, d7, a20, n8) {
    if (!this._proxy) throw new e24({ error: "Embedded wallet proxy not initialized", code: "embedded_wallet_webview_not_loaded" });
    return e25(e37) || (!n8 || i21 || d7 || a20) && await this._load({ wallet: e37, entropyId: r20, entropyIdVerifier: o19, recoveryPassword: i21, recoveryAccessToken: d7, recoverySecretOverride: a20 }), new i14({ account: e37, privyInternal: this._privyInternal, proxy: this._proxy, entropyId: r20, entropyIdVerifier: o19, onNeedsRecovery: n8, app: this._appApi });
  }
  async setRecovery(e37) {
    let { wallet: r20, ...o19 } = e37;
    if (!this._proxy) throw Error("Embedded wallet proxy not initialized");
    if (e25(r20)) throw new e24({ error: "This wallet does not support setting recovery methods", code: "unsupported_recovery_method" });
    i10({ currentRecoveryMethod: r20.recovery_method, upgradeToRecoveryMethod: "icloud-native" === o19.recoveryMethod ? "icloud" : o19.recoveryMethod }), await this._load("solana" === r20.chain_type ? { wallet: r20, entropyId: r20.address, entropyIdVerifier: "solana-address-verifier" } : { wallet: r20, entropyId: r20.address, entropyIdVerifier: "ethereum-address-verifier" });
    let i21 = await this._privyInternal.getAccessTokenInternal();
    if (!i21) throw Error("User must be logged in to interact with embedded wallets");
    let d7 = r20.recovery_method;
    this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_set_recovery_started", { address: r20.address, target_recovery_method: o19.recoveryMethod, existing_recovery_method: d7 });
    try {
      let e38;
      if ("user-passcode" === o19.recoveryMethod) e38 = { recoveryMethod: "user-passcode", recoveryPassword: o19.password };
      else if ("google-drive" === o19.recoveryMethod) e38 = { recoveryMethod: "google-drive", recoveryAccessToken: o19.recoveryAccessToken };
      else if ("icloud" === o19.recoveryMethod) e38 = { recoveryMethod: "icloud", recoveryAccessToken: o19.recoveryAccessToken };
      else if ("icloud-native" === o19.recoveryMethod) e38 = { recoveryMethod: "icloud-native", iCloudRecordNameOverride: o19.iCloudRecordNameOverride, recoverySecretOverride: o19.recoverySecretOverride };
      else if ("recovery-encryption-key" === o19.recoveryMethod) e38 = { recoveryMethod: "recovery-encryption-key", recoveryKey: o19.recoveryKey };
      else {
        if ("privy" !== o19.recoveryMethod) throw Error(`Unknown recovery method: ${o19.recoveryMethod}`);
        e38 = { recoveryMethod: "privy" };
      }
      await this._proxy.setRecovery({ accessToken: i21, entropyId: r20.address, entropyIdVerifier: "solana" === r20.chain_type ? "solana-address-verifier" : "ethereum-address-verifier", ...e38 }), this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_set_recovery_completed", { address: r20.address, target_recovery_method: o19.recoveryMethod, existing_recovery_method: d7 });
      let { user: t40 } = await this._privyInternal.refreshSession();
      return { user: t40, provider: "ethereum" !== r20.chain_type ? null : new l3({ account: r20, entropyId: r20.address, entropyIdVerifier: "ethereum-address-verifier", privyInternal: this._privyInternal, chains: this._chains, walletProxy: this._proxy, appApi: this._appApi }) };
    } catch (e38) {
      throw this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_set_recovery_failed", { address: r20.address, recovery_method: r20.recovery_method, error: e38 instanceof Error ? e38.message : "Unable to recover wallet" }), e38;
    }
  }
  getURL() {
    let e37 = new URL(`${this._privyInternal.baseUrl}/apps/${this._privyInternal.appId}/embedded-wallets`);
    return this._privyInternal.caid && e37.searchParams.append("caid", this._privyInternal.caid), this._privyInternal.appClientId && e37.searchParams.append("client_id", this._privyInternal.appClientId), e37.href;
  }
  get chains() {
    return this._chains;
  }
  onMessage(e37) {
    if (!this._proxy) throw Error("Embedded wallet proxy not initialized");
    return this._proxy.handleEmbeddedWalletMessages(e37);
  }
  reload() {
  ...
  async ping(e37) {
    try {
      if (!this._proxy) throw Error("Embedded wallet proxy not initialized");
      return await this._proxy.ping(e37), true;
    } catch (e38) {
      return console.error(e38), false;
    }
  }
  async _load({ entropyId: e37, entropyIdVerifier: r20, wallet: t40, recoveryPassword: o19, recoveryKey: d7, recoveryAccessToken: a20, recoverySecretOverride: s11 }) {
    if (!this._proxy) throw Error("Embedded wallet proxy not initialized");
    let n8 = await this._privyInternal.getAccessTokenInternal();
    if (!n8) throw Error("User must be logged in to interact with embedded wallets");
    try {
      return await this._proxy.connect({ accessToken: n8, entropyId: e37, entropyIdVerifier: r20 }), e37;
    } catch (c4) {
      if (E(c4)) try {
        if ("privy" === t40.recovery_method) {
          this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_started", { address: t40.address, recovery_method: t40.recovery_method });
          let o20 = await this._proxy.recover({ accessToken: n8, entropyId: e37, entropyIdVerifier: r20 });
          return this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_completed", { address: t40.address, recovery_method: t40.recovery_method }), o20.entropyId;
        }
        if ("user-passcode" === t40.recovery_method && o19) {
          this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_started", { address: t40.address, recovery_method: t40.recovery_method });
          let i21 = await this._proxy.recover({ accessToken: n8, recoveryPassword: o19, entropyId: e37, entropyIdVerifier: r20 });
          return this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_completed", { address: t40.address, recovery_method: t40.recovery_method }), i21.entropyId;
        }
        if (["google-drive", "icloud"].includes(t40.recovery_method) && a20) {
          this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_started", { address: t40.address, recovery_method: t40.recovery_method });
          let o20 = await this._proxy.recover({ accessToken: n8, recoveryAccessToken: a20, entropyId: e37, entropyIdVerifier: r20 });
          return this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_completed", { address: t40.address, recovery_method: t40.recovery_method }), o20.entropyId;
        }
        if ("icloud" === t40.recovery_method && s11) {
          this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_started", { address: t40.address, recovery_method: "icloud-native" });
          let o20 = await this._proxy.recover({ accessToken: n8, recoverySecretOverride: s11, entropyId: e37, entropyIdVerifier: r20 });
          return this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_completed", { address: t40.address, recovery_method: "icloud-native" }), o20.entropyId;
        }
        if ("recovery-encryption-key" === t40.recovery_method && d7) {
          this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_started", { address: t40.address, recovery_method: t40.recovery_method });
          let o20 = await this._proxy.recover({ accessToken: n8, recoveryKey: d7, entropyId: e37, entropyIdVerifier: r20 });
          return this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_completed", { address: t40.address, recovery_method: t40.recovery_method }), o20.entropyId;
        }
      } catch (r21) {
        throw this._privyInternal.createAnalyticsEvent("embedded_wallet_sdk_recovery_failed", { address: t40.address, recovery_method: t40.recovery_method, error: r21 instanceof Error ? r21.message : `Unable to recover wallet: ${e37}` }), r21;
      }
      throw c4;
    }
  }
  constructor(t40, o19, i21, d7, a20, s11) {
    if (this._chains = Array.from(x), this._privyInternal = t40, o19 && (this._proxy = new h8(o19, a20), d7.setProxy(this._proxy)), i21) {
      let e37 = t24(i21);
      this._chains = e37;
    }
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/MfaPromises.mjs
var r13 = class extends eventemitter3_default {
  constructor() {
    super(), this.rootPromise = { current: null }, this.submitPromise = { current: null };
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/PrivyInternal.mjs
var import_fetch_retry = __toESM(require_fetch_retry_umd(), 1);

// ../monorepo/platform/node_modules/uuid/dist/esm-browser/rng.js
var getRandomValues;
...
// ../monorepo/platform/node_modules/uuid/dist/esm-browser/stringify.js
var byteToHex = [];
for (let i21 = 0; i21 < 256; ++i21) {
  byteToHex.push((i21 + 256).toString(16).slice(1));
}
function unsafeStringify(arr, offset = 0) {
  return byteToHex[arr[offset + 0]] + byteToHex[arr[offset + 1]] + byteToHex[arr[offset + 2]] + byteToHex[arr[offset + 3]] + "-" + byteToHex[arr[offset + 4]] + byteToHex[arr[offset + 5]] + "-" + byteToHex[arr[offset + 6]] + byteToHex[arr[offset + 7]] + "-" + byteToHex[arr[offset + 8]] + byteToHex[arr[offset + 9]] + "-" + byteToHex[arr[offset + 10]] + byteToHex[arr[offset + 11]] + byteToHex[arr[offset + 12]] + byteToHex[arr[offset + 13]] + byteToHex[arr[offset + 14]] + byteToHex[arr[offset + 15]];
}

// ../monorepo/platform/node_modules/uuid/dist/esm-browser/native.js
var randomUUID = typeof crypto !== "undefined" && crypto.randomUUID && crypto.randomUUID.bind(crypto);
var native_default = {
  randomUUID
};

// ../monorepo/platform/node_modules/uuid/dist/esm-browser/v4.js
function v4(options, buf, offset) {
  ...
  if (buf) {
    offset = offset || 0;
    for (let i21 = 0; i21 < 16; ++i21) {
      buf[offset + i21] = rnds[i21];
    }
    return buf;
  }
...
function init(converter, defaultAttributes) {
  ...
  function get(name) {
    ...
    var jar = {};
    for (var i21 = 0; i21 < cookies.length; i21++) {
      var parts = cookies[i21].split("=");
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/allSettled.mjs
var e31 = Promise.allSettled.bind(Promise) ?? ((e37) => Promise.all(e37.map(((e38) => e38.then(((e39) => ({ status: "fulfilled", value: e39 }))).catch(((e39) => ({ status: "rejected", reason: e39 })))))));

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/Session.mjs
var o11 = "privy:token";
var n5 = "privy-token";
var a17 = "privy:pat";
...
var l4 = "privy-id-token";
var c = "privy-session";
var k = class extends eventemitter3_default {
  set isUsingServerCookies(e37) {
    this._isUsingServerCookies = e37;
  }
  async getCustomerAccessToken() {
    let e37 = await this._storage.get(o11);
    try {
      return "string" == typeof e37 ? new t13(e37).value : null;
    } catch (e38) {
      return console.error(e38), await this.destroyLocalState({ reason: "getToken_error" }), null;
    }
  }
  async getPrivyAccessToken() {
    let e37 = await this._storage.get(a17);
    try {
      return "string" == typeof e37 ? new t13(e37).value : null;
    } catch (e38) {
      return console.error(e38), await this.destroyLocalState({ reason: "getToken_error" }), null;
  ...
  async getRefreshToken() {
    let e37 = await this._storage.get(_3);
    return "string" == typeof e37 ? e37 : null;
  }
  async getIdentityToken() {
    let e37 = await this._storage.get(g);
    return "string" == typeof e37 ? e37 : null;
  }
  get mightHaveServerCookies() {
    try {
      let e37 = api.get(c);
      return void 0 !== e37 && e37.length > 0;
    } catch (e37) {
      console.error(e37);
    }
    return false;
  }
  hasRefreshCredentials(e37, t40) {
    return this.mightHaveServerCookies || "string" == typeof e37 && "string" == typeof t40;
  }
  tokenIsActive(e37) {
    if (!e37) return false;
    let t40 = t13.parse(e37);
    return null !== t40 && !t40.isExpired(30);
  }
  async destroyLocalState(e37) {
    await e31([this._storage.del(o11), this._storage.del(_3), this._storage.del(g), this._storage.del(this.GUEST_CREDENTIAL_STORAGE_KEY)]), api.remove(n5), api.remove(h9), api.remove(l4), api.remove(c), e37?.reason && this.emit("storage_cleared", { reason: e37.reason });
  }
  async storeCustomerAccessToken(e37) {
    if ("string" == typeof e37) {
      let t40 = await this._storage.get(o11);
      if (await this._storage.put(o11, e37), !this._isUsingServerCookies) {
        let t41 = t13.parse(e37)?.expiration;
        api.set(n5, e37, { sameSite: "Strict", secure: true, expires: t41 ? new Date(1e3 * t41) : void 0 });
      }
      t40 !== e37 && this.emit("token_stored", { cookiesEnabled: this._isUsingServerCookies });
    } else {
      let e38 = await this._storage.get(o11);
      await this._storage.del(o11), api.remove(n5), null !== e38 && this.emit("token_cleared", { reason: "set_with_non_string_value" });
    }
  }
  async storePrivyAccessToken(e37) {
    "string" == typeof e37 ? await this._storage.put(a17, e37) : await this._storage.del(a17);
  }
  async storeRefreshToken(e37) {
    "string" == typeof e37 ? (await this._storage.put(_3, e37), this._isUsingServerCookies || (api.set(c, "t", { sameSite: "Strict", secure: true, expires: 30 }), api.set(h9, e37, { sameSite: "Strict", secure: true, expires: 30 })), this.emit("refresh_token_stored", { cookiesEnabled: this._isUsingServerCookies })) : (await this._storage.del(_3), api.remove(h9), api.remove(c), this.emit("refresh_token_cleared", { reason: "set_with_non_string_value" }));
  }
  async updateWithTokensResponse(e37) {
    let t40 = (await e31([this.storeCustomerAccessToken(e37.token), this.storePrivyAccessToken(e37.privy_access_token), this.storeRefreshToken(e37.refresh_token), this.storeIdentityToken(e37.identity_token), this.processOAuthTokens(e37.oauth_tokens)])).filter(((e38) => "rejected" === e38.status));
    t40.length > 0 && this.emit("error_storing_tokens", t40.map(((e38) => String(e38.reason))).join(", "));
  }
  async processOAuthTokens(e37) {
    e37 && this.emit("oauth_tokens_granted", e37);
  }
  async storeIdentityToken(e37) {
    if ("string" == typeof e37) {
      let t40 = await this._storage.get(g);
      if (await this._storage.put(g, e37), !this._isUsingServerCookies) {
        let t41 = t13.parse(e37)?.expiration;
        api.set(l4, e37, { sameSite: "Strict", secure: true, expires: t41 ? new Date(1e3 * t41) : void 0 });
      }
      t40 !== e37 && this.emit("identity_token_stored", { cookiesEnabled: this._isUsingServerCookies });
    } else {
      let e38 = await this._storage.get(g);
      await this._storage.del(g), api.remove(l4), null !== e38 && this.emit("identity_token_cleared", { reason: "set_with_non_string_value" });
    }
  }
  async getOrCreateGuestCredential() {
    let e37 = this._storage.get(this.GUEST_CREDENTIAL_STORAGE_KEY);
    if (e37 && "string" == typeof e37) return e37;
  ...
  constructor(e37) {
    super(), this._isUsingServerCookies = false, this._storage = e37.storage, this.GUEST_CREDENTIAL_STORAGE_KEY = `privy:guest:${e37.appId}`;
  }
};
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/toAbortSignalTimeout.mjs
var t32 = (t40) => {
  let e37 = new AbortController();
  return setTimeout((() => e37.abort()), t40), e37.signal;
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/toSearchParams.mjs
function r14(r20) {
  let n8 = new URLSearchParams();
  for (let t40 in r20) null != r20[t40] && n8.append(t40, String(r20[t40]));
  return Array.from(n8).length ? "?" + n8.toString() : "";
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/noop.mjs
var o12 = () => {
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/logger.mjs
var o13 = { NONE: Number.NEGATIVE_INFINITY, ERROR: 1, WARN: 2, INFO: 3, DEBUG: Number.POSITIVE_INFINITY };
var r15 = ({ level: r20 } = { level: "ERROR" }) => ({ get level() {
  return r20;
}, error: o13[r20] >= o13.ERROR ? console.error : o12, warn: o13[r20] >= o13.WARN ? console.warn : o12, info: o13[r20] >= o13.INFO ? console.info : o12, debug: o13[r20] >= o13.DEBUG ? console.debug : o12 });

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/PrivyInternal.mjs
var p12 = "privy:caid";
var u = class {
  setCallbacks(e37) {
    this.callbacks = { ...this.callbacks, ...e37 };
  }
  get isReady() {
    return !!this._config;
  }
  ...
  getPath(e37, { params: t40, query: s11 }) {
    return `${this.baseUrl}${e6(e37.path, t40)}${r14(s11)}`;
  }
  async fetch(e37, { body: t40, params: s11, query: i21, headers: r20, onRequest: a20 = this._beforeRequest.bind(this) }) {
    let o19 = new Request(this.getPath(e37, { params: s11, query: i21 }), { method: e37.method, body: JSON.stringify(t40), headers: r20 }), n8 = await a20(o19), c4 = await this._fetch(o19, n8), l8 = await c4.json();
    if (c4.status > 299) throw new r6(l8);
    return l8;
  }
  async _beforeRequestWithoutInitialize(e37) {
    let t40 = await this.session.getPrivyAccessToken() ?? await this.session.getCustomerAccessToken(), s11 = new Headers(e37.headers);
    s11.set("privy-app-id", this.appId), this.appClientId && s11.set("privy-client-id", this.appClientId), s11.set("privy-client", this._sdkVersion), t40 && s11.set("Authorization", `Bearer ${t40}`), s11.set("Content-Type", "application/json"), s11.set("Accept", "application/json");
    let i21 = await this._getOrGenerateClientAnalyticsId();
    return i21 && s11.set("privy-ca-id", i21), this.nativeAppIdentifier && s11.set("x-native-app-identifier", this.nativeAppIdentifier), { signal: t32(2e4), headers: s11, credentials: "include" };
  }
  async beforeRequestWithoutRefresh(e37) {
    return await this._initialize(), this._beforeRequestWithoutInitialize(e37);
  }
  async _beforeRequest(e37) {
    return await this._initialize(), await this.getAccessTokenInternal(), this.beforeRequestWithoutRefresh(e37);
  }
  async getAppConfig() {
  ...
  async _getOrGenerateClientAnalyticsId() {
    ...
    try {
      let e37 = await this._storage.get(p12);
      if ("string" == typeof e37 && e37.length > 0) return this._analyticsId = e37, e37;
    } catch (e37) {
      this.logger.error("Unable to load clientId", e37);
    }
    try {
      this._analyticsId = v4_default();
    } catch (e37) {
      this.logger.error("Unable to generate uuidv4", e37);
    }
    if (this._analyticsId) {
      try {
        await this._storage.put(p12, this._analyticsId);
      } catch (e37) {
        this.logger.error(`Unable to store clientId: ${this._analyticsId}`, e37);
      }
      return this._analyticsId;
    }
  }
  async destroyClientAnalyticsId() {
    try {
      return await this._storage.del(p12);
    } catch (e37) {
      this.logger.error("Unable to delete clientId", e37);
    }
  }
  async createAnalyticsEvent(e37, t40) {
    try {
      await this.fetch(t, { body: { event_name: e37, client_id: await this._getOrGenerateClientAnalyticsId(), payload: t40 }, onRequest: this.beforeRequestWithoutRefresh.bind(this) });
    } catch (e38) {
    }
  }
  async refreshSession(e37 = false) {
    if (!await this.isStorageAccessible()) throw new e24({ code: "storage_error", error: "Unable to access storage" });
    let t40 = await this.session.getRefreshToken() ?? void 0, s11 = t40 ?? "key", i21 = this._cache.get(s11);
    if (i21) return this.logger.debug("[privy:refresh] found in-flight session refresh request, deduping"), await i21;
    let r20 = this._refreshSession(t40, e37);
  ...
  async _refreshSession(e37, t40) {
    let i21 = await this.session.getCustomerAccessToken();
    if (!this.session.hasRefreshCredentials(i21, e37 ?? null)) throw this.logger.debug("[privy:refresh] missing tokens, skipping request"), await this._initialize(), new r6({ code: I.MISSING_OR_INVALID_TOKEN, error: "No tokens found in storage" });
    try {
      this.logger.debug(`[privy:refresh] fetching: ${s4.path}`);
      let s11 = await this.fetch(s4, { body: { refresh_token: e37 }, onRequest: this.beforeRequestWithoutRefresh.bind(this) }), i22 = s11.session_update_action;
      return this.logger.debug(`[privy:refresh] response: ${i22}`), "set" === i22 && (await this.session.updateWithTokensResponse(s11), this.logger.debug("[privy:refresh] tokens stored")), "clear" === i22 && (await this.session.destroyLocalState(), this.logger.debug("[privy:refresh] tokens cleared"), t40 || this.callbacks?.setUser?.(null)), "ignore" === i22 && (s11.token && (await this.session.storeCustomerAccessToken(s11.token), this.logger.debug("[privy:refresh] token stored (CAT)")), s11.privy_access_token && (await this.session.storePrivyAccessToken(s11.privy_access_token), this.logger.debug("[privy:refresh] token stored (PAT)")), s11.identity_token && (this.logger.debug("[privy:refresh] token stored (IDT)"), await this.session.storeIdentityToken(s11.identity_token))), this.logger.debug("[privy:refresh] returning response"), t40 || this.callbacks?.setUser?.(s11.user), s11;
    } catch (e38) {
      throw this.logger.debug(`[privy:refresh] error: ${e38.message ?? "unknown error"}`), e38 instanceof r6 && e38.code === I.MISSING_OR_INVALID_TOKEN && (await this.session.destroyLocalState(), t40 || this.callbacks?.setUser?.(null)), e38;
    }
  }
  async getAccessToken() {
    let [e37, t40] = await Promise.all([this.session.getCustomerAccessToken(), this.session.getRefreshToken()]);
    if (!this.session.tokenIsActive(e37) && this.session.hasRefreshCredentials(e37, t40)) {
      let t41 = await this.refreshSession(), s11 = await this.session.getCustomerAccessToken();
      return t41.token || this.logger.debug("[privy:getAccessToken] expected token received null"), t41.token === e37 && this.logger.debug("[privy:getAccessToken] expected new token in response received existing"), s11 === e37 && this.logger.debug("[privy:getAccessToken] expected new token in storage received existing"), t41.token ?? s11;
    }
    return e37;
  }
  async getAccessTokenInternal() {
    let e37 = await this.getAccessToken();
    return await this.session.getPrivyAccessToken() ?? e37;
  }
  async getIdentityToken() {
  ...
  async isStorageAccessible() {
    try {
      let e37 = `privy:__storage__test-${v4_default()}`, s11 = "blobby";
      await this._storage.put(e37, s11);
      let i21 = await this._storage.get(e37);
      return await this._storage.del(e37), i21 === s11;
    } catch (e37) {
      return this.logger.error(e37), false;
    }
  }
  constructor(t40) {
    this._sdkVersion = "js-sdk-core:0.59.0", this._cache = /* @__PURE__ */ new Map(), this.logger = r15({ level: t40.logLevel ?? "ERROR" }), this._storage = t40.storage, this._analyticsId = null, this._getOrGenerateClientAnalyticsId(), this.baseUrl = t40.baseUrl ?? "https://auth.privy.io", this.appId = t40.appId, this.appClientId = t40.appClientId, this._sdkVersion = t40.sdkVersion ?? this._sdkVersion, this.callbacks = t40.callbacks, this.nativeAppIdentifier = t40.nativeAppIdentifier, this.session = new k({ storage: this._storage, isUsingServerCookies: false, appId: t40.appId }), this._fetch = (0, import_fetch_retry.default)(globalThis.fetch, { retries: 3, retryDelay: (e37) => 3 ** e37 * 500, retryOn: [408, 409, 425, 500, 502, 503, 504] }), this.session.on("error_storing_tokens", ((e37) => {
      this.createAnalyticsEvent("error_updating_tokens_in_storage", { reason: e37 });
    }));
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/UserApi.mjs
var t33 = class {
  async get() {
    let { user: r20 } = await this._privyInternal.refreshSession();
    return { user: r20 };
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/embedded-wallets.mjs
var e33 = (e37) => "wallet" === e37.type && "privy" === e37.wallet_client_type && "embedded" === e37.connector_type;

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/getAllUserEmbeddedEthereumWallets.mjs
var t34 = (t40) => t40 ? t40.linked_accounts.filter(e33).filter(((e37) => "ethereum" === e37.chain_type)).sort(((e37, t41) => e37.wallet_index - t41.wallet_index)) : [];

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/getUserEmbeddedEthereumWallet.mjs
var l5 = (l8) => t34(l8).find(((e37) => 0 === e37.wallet_index)) ?? null;

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/getAllUserEmbeddedSolanaWallets.mjs
var t35 = (t40) => t40 ? t40.linked_accounts.filter(e33).filter(((e37) => "solana" === e37.chain_type)).sort(((e37, t41) => e37.wallet_index - t41.wallet_index)) : [];

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/getUserEmbeddedSolanaWallet.mjs
var l6 = (l8) => t35(l8).find(((e37) => 0 === e37.wallet_index)) ?? null;

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/shouldCreateEmbeddedEthWallet.mjs
var t36 = (t40, l8) => !("off" === l8 || t34(t40).length > 0 || t40.linked_accounts.filter(((e37) => "wallet" === e37.type && "ethereum" === e37.chain_type)).length > 0 && "all-users" !== l8);

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/utils/shouldCreateEmbeddedSolWallet.mjs
var l7 = (l8, t40) => !("off" === t40 || t35(l8).length > 0 || l8.linked_accounts.filter(((e37) => "wallet" === e37.type && "solana" === e37.chain_type)).length > 0 && "all-users" !== t40);

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/maybeCreateWalletOnLogin.mjs
var o14 = async (o19, a20, l8) => {
  let u4 = t36(a20.user, l8?.ethereum?.createOnLogin ?? "off"), i21 = l7(a20.user, l8?.solana?.createOnLogin ?? "off");
  if (u4 && i21) {
    let t40 = await o19.create({ recoveryMethod: "privy", skipCallbacks: true });
    return { ...await o19.createSolana({ ethereumAccount: l5(t40.user) ?? void 0 }), is_new_user: a20.is_new_user, oauth_tokens: a20.oauth_tokens };
  }
  return u4 ? { ...await o19.create({ recoveryMethod: "privy", solanaAccount: l6(a20.user) ?? void 0 }), is_new_user: a20.is_new_user, oauth_tokens: a20.oauth_tokens } : i21 ? { ...await o19.createSolana({ ethereumAccount: l5(a20.user) ?? void 0 }), is_new_user: a20.is_new_user, oauth_tokens: a20.oauth_tokens } : a20;
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/CustomProviderApi.mjs
var s9 = class {
  async syncWithToken(s11, l8, r20) {
    let d7 = await this._privyInternal.fetch(t2, { body: { token: s11, mode: r20 } });
    await this._privyInternal.session.updateWithTokensResponse(d7);
    let i21 = await o14(this._embedded, d7, l8?.embedded);
    return this._privyInternal.callbacks?.setUser?.(i21.user), i21;
  }
  constructor(e37, t40) {
    this._privyInternal = e37, this._embedded = t40;
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/EmailApi.mjs
var a18 = class {
  async sendCode(t40, s11) {
    return this._privyInternal.fetch(a6, { body: { email: t40, token: s11 } });
  }
  async loginWithCode(e37, s11, i21, r20) {
    let a20 = await this._privyInternal.fetch(s2, { body: { email: e37, code: s11, mode: i21 } });
    await this._privyInternal.session.updateWithTokensResponse(a20);
    let l8 = await o14(this._embedded, a20, r20?.embedded);
    return this._privyInternal.callbacks?.setUser?.(l8.user), l8;
  }
  async linkWithCode(e37, t40) {
    await this._privyInternal.fetch(p6, { body: { email: e37, code: t40 } });
    let i21 = await this._privyInternal.refreshSession();
    return { user: i21.user, identity_token: i21.identity_token };
  }
  async updateEmail({ oldEmailAddress: e37, newEmailAddress: t40, code: s11 }) {
    await this._privyInternal.fetch(e3, { body: { oldAddress: e37, newAddress: t40, code: s11 } });
    let r20 = await this._privyInternal.refreshSession();
    return { user: r20.user, identity_token: r20.identity_token };
  }
  async unlink(e37) {
    await this._privyInternal.fetch(t7, { body: { address: e37 } });
    let t40 = await this._privyInternal.refreshSession();
    return { user: t40.user, identity_token: t40.identity_token };
  }
  constructor(e37, t40) {
    this._privyInternal = e37, this._embedded = t40;
  }
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/FarcasterApi.mjs
var n6 = class {
  async initializeAuth({ relyingParty: t40, redirectUrl: r20, token: i21 }) {
    return await this._privyInternal.fetch(a2, { body: { relying_party: t40, redirect_url: r20, token: i21 } });
  }
  async getFarcasterStatus({ channel_token: e37 }) {
    return await this._privyInternal.fetch(i, { headers: { "farcaster-channel-token": e37 } });
  }
  async authenticate({ channel_token: e37, message: t40, signature: i21, fid: s11, mode: n8 }, l8) {
    let d7 = await this._privyInternal.fetch(t3, { body: { channel_token: e37, message: t40, signature: i21, fid: s11, mode: n8 } });
    await this._privyInternal.session.updateWithTokensResponse(d7);
    let o19 = await o14(this._embedded, d7, l8?.embedded);
    return this._privyInternal.callbacks?.setUser?.(o19.user), o19;
  }
  async link({ channel_token: e37, message: t40, signature: r20, fid: s11 }) {
    await this._privyInternal.fetch(e, { body: { channel_token: e37, message: t40, signature: r20, fid: s11 } });
    let a20 = await this._privyInternal.refreshSession();
    return { user: a20.user, identity_token: a20.identity_token };
  }
  async unlink({ fid: e37 }) {
    await this._privyInternal.fetch(h, { body: { fid: e37 } });
    let t40 = await this._privyInternal.refreshSession();
    return { user: t40.user, identity_token: t40.identity_token };
  }
  constructor(e37, t40) {
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/FarcasterV2Api.mjs
var i15 = class {
  async initializeAuth() {
    return await this._privyInternal.fetch(p3, { body: {} });
  }
  async authenticate({ message: e37, signature: i21, fid: a20 }, l8) {
    let r20 = await this._privyInternal.fetch(r, { body: { message: e37, signature: i21, fid: a20 } });
    await this._privyInternal.session.updateWithTokensResponse(r20);
    let d7 = await o14(this._embedded, r20, l8?.embedded);
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/GuestApi.mjs
var s10 = class {
  async create(s11) {
    let l8 = await this._privyInternal.session.getOrCreateGuestCredential(), r20 = await this._privyInternal.fetch(t4, { body: { guest_credential: l8 } });
    await this._privyInternal.session.updateWithTokensResponse(r20);
    let a20 = await o14(this._embedded, r20, s11?.embedded);
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/pkce.mjs
var t37 = "privy:state_code";
var n7 = "privy:code_verifier";
async function r16(e37, t40) {
  let n8 = new TextEncoder().encode(e37);
  return new Uint8Array(await t40("SHA-256", n8));
}
function o15(e37) {
  return crypto.getRandomValues(new Uint8Array(e37));
}
function i16() {
  return base64url_exports.encode(o15(36));
}
function c2() {
  return i16();
}
async function u2({ codeVerifier: t40, method: n8 = "S256", digest: o19 = crypto.subtle.digest.bind(crypto.subtle) }) {
  if ("S256" != n8) return t40;
  {
    let n9 = await r16(t40, o19);
    return base64url_exports.encode(n9);
  }
}

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/OAuthApi.mjs
var m2 = class {
  async generateURL(t40, i21) {
    let s11 = i16(), r20 = c2(), h10 = await u2({ codeVerifier: s11, digest: this._crypto?.digest });
    return await Promise.all([this._storage.put(n7, s11), this._storage.put(t37, r20)]), this._privyInternal.fetch(a4, { body: { redirect_to: i21, provider: t40, code_challenge: h10, state_code: r20 } });
  }
  async loginWithCode(e37, i21, s11, a20, o19, l8) {
    let [m3, p13] = await Promise.all([this._storage.get(n7), this._storage.get(t37)]);
    if (p13 !== i21) throw this._privyInternal.createAnalyticsEvent("possible_phishing_attempt", { flow: "oauth", provider: s11, storedStateCode: p13 ?? "", returnedStateCode: i21 ?? "" }), new e24({ code: "pkce_state_code_mismatch", error: "Unexpected auth flow. This may be a phishing attempt." });
    let _4 = await this._privyInternal.fetch(t5, { body: { authorization_code: e37, code_type: a20, state_code: p13, code_verifier: m3, mode: o19 } });
    await this._privyInternal.session.updateWithTokensResponse(_4);
    let c4 = await o14(this._embedded, _4, l8?.embedded);
    return await Promise.all([this._storage.del(n7), this._storage.del(t37)]), this._privyInternal.callbacks?.setUser?.(c4.user), c4;
  }
  async linkWithCode(e37, t40, s11, a20) {
    let [o19, l8] = await Promise.all([this._storage.get(n7), this._storage.get(t37)]);
    if (l8 !== t40) throw this._privyInternal.createAnalyticsEvent("possible_phishing_attempt", { flow: "oauth", provider: s11, storedStateCode: l8 ?? "", returnedStateCode: t40 ?? "" }), new e24({ code: "pkce_state_code_mismatch", error: "Unexpected auth flow. This may be a phishing attempt." });
    let h10 = await this._privyInternal.fetch(h2, { body: { authorization_code: e37, code_type: a20, state_code: l8, code_verifier: o19 } });
    await this._privyInternal.session.processOAuthTokens(h10.oauth_tokens);
    let m3 = await this._privyInternal.refreshSession();
    return await Promise.all([this._storage.del(n7), this._storage.del(t37)]), { user: m3.user, identity_token: m3.identity_token };
  }
  async unlink(e37, t40) {
    await this._privyInternal.fetch(o, { body: { provider: e37, subject: t40 } });
    let i21 = await this._privyInternal.refreshSession();
    return { user: i21.user, identity_token: i21.identity_token };
  }
  constructor(e37, t40, i21, s11) {
    this._privyInternal = e37, this._embedded = t40, this._storage = i21, this._crypto = s11;
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/PasskeyApi.mjs
var o16 = class {
  async generateRegistrationOptions(t40) {
    return await this._privyInternal.fetch(i2, { body: { relying_party: t40 } });
  }
  async generateAuthenticationOptions(e37) {
    return await this._privyInternal.fetch(e2, { body: { relying_party: e37 } });
  }
  async generateSignupOptions(e37) {
    return await this._privyInternal.fetch(p5, { body: { relying_party: e37 } });
  }
  async loginWithPasskey(e37, t40, s11, n8) {
    let i21 = await this._privyInternal.fetch(a5, { body: { relying_party: s11, challenge: t40, authenticator_response: this._transformAuthenticationResponseToSnakeCase(e37) } });
    await this._privyInternal.session.updateWithTokensResponse(i21);
    let o19 = await o14(this._embedded, i21, n8?.embedded);
    return this._privyInternal.callbacks?.setUser?.(o19.user), o19;
  }
  async signupWithPasskey(e37, t40, s11) {
    let a20 = await this._privyInternal.fetch(s, { body: { relying_party: t40, authenticator_response: this._transformRegistrationResponseToSnakeCase(e37) } });
    await this._privyInternal.session.updateWithTokensResponse(a20);
    let i21 = await o14(this._embedded, a20, s11?.embedded);
    return this._privyInternal.callbacks?.setUser?.(i21.user), i21;
  }
  async linkWithPasskey(e37, t40) {
    await this._privyInternal.fetch(t6, { body: { relying_party: t40, authenticator_response: this._transformRegistrationResponseToSnakeCase(e37) } });
    let s11 = await this._privyInternal.refreshSession();
    return { user: s11.user, identity_token: s11.identity_token };
  }
  _transformRegistrationResponseToSnakeCase(e37) {
    return { type: e37.type, id: e37.id, raw_id: e37.rawId, response: { client_data_json: e37.response.clientDataJSON, attestation_object: e37.response.attestationObject, authenticator_data: e37.response.authenticatorData || void 0, transports: e37.response.transports || void 0, public_key: e37.response.publicKey || void 0, public_key_algorithm: e37.response.publicKeyAlgorithm || void 0 }, authenticator_attachment: e37.authenticatorAttachment || void 0, client_extension_results: { app_id: e37.clientExtensionResults.appid || void 0, cred_props: e37.clientExtensionResults.credProps || void 0, hmac_create_secret: e37.clientExtensionResults.hmacCreateSecret || void 0 } };
  }
  _transformAuthenticationResponseToSnakeCase(e37) {
    return { type: e37.type, id: e37.id, raw_id: e37.rawId, response: { signature: e37.response.signature, client_data_json: e37.response.clientDataJSON, authenticator_data: e37.response.authenticatorData, user_handle: e37.response.userHandle || void 0 }, authenticator_attachment: e37.authenticatorAttachment || void 0, client_extension_results: { app_id: e37.clientExtensionResults.appid || void 0, cred_props: e37.clientExtensionResults.credProps || void 0, hmac_create_secret: e37.clientExtensionResults.hmacCreateSecret || void 0 } };
  }
  constructor(e37, t40) {
    this._privyInternal = e37, this._embedded = t40;
  }
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/PhoneApi.mjs
var o17 = class {
  async sendCode(t40, r20) {
    return this._privyInternal.fetch(a7, { body: { phoneNumber: t40, token: r20 } });
  }
  async loginWithCode(e37, r20, i21, n8) {
    let o19 = await this._privyInternal.fetch(s3, { body: { phoneNumber: e37, code: r20, mode: i21 } });
    await this._privyInternal.session.updateWithTokensResponse(o19);
    let a20 = await o14(this._embedded, o19, n8?.embedded);
    return this._privyInternal.callbacks?.setUser?.(a20.user), a20;
  }
  async linkWithCode(e37, t40) {
    await this._privyInternal.fetch(p7, { body: { phoneNumber: e37, code: t40 } });
    let i21 = await this._privyInternal.refreshSession();
    return { user: i21.user, identity_token: i21.identity_token };
  }
  async updatePhone({ oldPhoneNumber: e37, newPhoneNumber: t40, code: r20 }) {
    await this._privyInternal.fetch(e4, { body: { old_phone_number: e37, new_phone_number: t40, code: r20 } });
    let n8 = await this._privyInternal.refreshSession();
    return { user: n8.user, identity_token: n8.identity_token };
  }
  async unlink(e37) {
    await this._privyInternal.fetch(t8, { body: { phoneNumber: e37 } });
    let t40 = await this._privyInternal.refreshSession();
    return { user: t40.user, identity_token: t40.identity_token };
  }
  constructor(e37, t40) {
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/SiweApi.mjs
var r17 = class {
  async unlinkWallet(t40) {
    await this._privyInternal.fetch(h4, { body: { address: t40 } });
    let i21 = await this._privyInternal.refreshSession();
    return { user: i21.user, identity_token: i21.identity_token };
  }
  async linkWithSiwe(e37, i21, n8) {
    let s11 = i21 || this._wallet, r20 = n8 || this._preparedMessage;
    ...
    await this._privyInternal.fetch(a9, { body: { message: r20, signature: e37, chainId: s11.chainId, walletClientType: s11.walletClientType ?? null, connectorType: s11.connectorType ?? null } });
    let a20 = await this._privyInternal.refreshSession();
    return { user: a20.user, identity_token: a20.identity_token };
  }
  async loginWithSiwe(e37, t40, n8, r20, a20) {
    let l8 = t40 || this._wallet, o19 = n8 || this._preparedMessage;
    if (!l8) throw Error("A wallet must be provided in the init step or as an argument to loginWithSiwe");
    if (!o19) throw Error("A message must be generated and signed before being used to login to privy with a wallet");
    let d7 = await this._privyInternal.fetch(i3, { body: { signature: e37, message: o19, chainId: l8.chainId, walletClientType: l8.walletClientType ?? null, connectorType: l8.connectorType ?? null, mode: r20 } });
    await this._privyInternal.session.updateWithTokensResponse(d7);
    let h10 = await o14(this._embedded, d7, a20?.embedded);
    return this._privyInternal.callbacks?.setUser?.(h10.user), h10;
  }
  async init(e37, t40, i21) {
    var s11;
    this._wallet = e37;
    let { nonce: r20 } = await this._privyInternal.fetch(t10, { body: { address: e37.address } }), a20 = `${(s11 = { chainId: e37.chainId.toString().replace("eip155:", ""), address: e37.address, issuedAt: (/* @__PURE__ */ new Date()).toISOString(), statement: "By signing, you are proving you own this wallet and logging in. This does not initiate a transaction or cost any fees.", domain: t40, nonce: r20, uri: i21 }).domain} wants you to sign in with your Ethereum account:
${s11.address}
...
- https://privy.io`;
  ...
  constructor(e37, t40) {
    this._wallet = void 0, this._privyInternal = e37, this._embedded = t40;
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/SiwsApi.mjs
var r18 = class {
  async unlink({ address: t40 }) {
    await this._privyInternal.fetch(h5, { body: { address: t40 } });
    let s11 = await this._privyInternal.refreshSession();
    return { user: s11.user, identity_token: s11.identity_token };
  }
  async link({ message: e37, signature: s11, walletClientType: l8, connectorType: n8 }) {
    await this._privyInternal.fetch(a10, { body: { message: e37, signature: s11, walletClientType: l8 ?? null, connectorType: n8 ?? null } });
    let r20 = await this._privyInternal.refreshSession();
    return { user: r20.user, identity_token: r20.identity_token };
  }
  async login({ mode: e37, message: t40, signature: l8, walletClientType: r20, connectorType: i21, opts: a20 }) {
    let d7 = await this._privyInternal.fetch(i4, { body: { signature: l8, message: t40, walletClientType: r20 ?? null, connectorType: i21 ?? null, mode: e37 } });
    await this._privyInternal.session.updateWithTokensResponse(d7);
    let o19 = await o14(this._embedded, d7, a20?.embedded);
    return this._privyInternal.callbacks?.setUser?.(o19.user), o19;
  }
  async fetchNonce({ address: e37 }) {
    let { nonce: t40 } = await this._privyInternal.fetch(t11, { body: { address: e37 } });
    return { nonce: t40 };
  }
  constructor(e37, t40) {
    this._privyInternal = e37, this._embedded = t40;
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/SmartWalletApi.mjs
var e34 = class {
  async link(t40, e37, i21, s11) {
    await this._privyInternal.fetch(e7, { body: { message: t40, signature: e37, smart_wallet_type: i21, smart_wallet_version: s11 } });
    let a20 = await this._privyInternal.refreshSession();
    return { user: a20.user, identity_token: a20.identity_token };
  }
  async init(n8) {
    var e37;
    let { nonce: i21 } = await this._privyInternal.fetch(t10, { body: { address: n8.address } });
    return { nonce: i21, message: `${(e37 = { chainId: n8.chainId.toString().replace("eip155:", ""), address: n8.address, issuedAt: (/* @__PURE__ */ new Date()).toISOString(), statement: "By signing, you are proving you own this wallet and logging in. This does not initiate a transaction or cost any fees.", domain: "privy.io", uri: "https://auth.privy.io", nonce: i21 }).domain} wants you to sign in with your Ethereum account:
${e37.address}
...
URI: ${e37.uri}
Version: 1
Chain ID: ${e37.chainId}
Nonce: ${e37.nonce}
Issued At: ${e37.issuedAt}
Resources:
- https://privy.io` };
  }
  constructor(n8) {
    this._privyInternal = n8;
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/auth/AuthApi.mjs
var d4 = class {
  async logout(e37) {
    try {
      let e38 = await this._privyInternal.session.getRefreshToken() ?? void 0;
      await this._privyInternal.fetch(o3, { body: { refresh_token: e38 } });
    } catch (t40) {
      console.warn("Error destroying session");
    }
    await Promise.all([this._privyInternal.session.destroyLocalState({ reason: "logout" }), this._privyInternal.destroyClientAnalyticsId(), e37?.userId && this._mfa.clearMfa({ userId: e37.userId })]), this._privyInternal.callbacks?.setUser?.(null);
  }
  constructor(t40, d7, y2, u4, j) {
    this._privyInternal = t40, this._mfa = j, this.customProvider = new s9(this._privyInternal, d7), this.phone = new o17(this._privyInternal, d7), this.email = new a18(this._privyInternal, d7), this.oauth = new m2(this._privyInternal, d7, y2, u4), this.guest = new s10(this._privyInternal, d7), this.siwe = new r17(this._privyInternal, d7), this.siws = new r18(this._privyInternal, d7), this.smartWallet = new e34(this._privyInternal), this.passkey = new o16(this._privyInternal, d7), this.farcaster = new n6(this._privyInternal, d7), this.farcasterV2 = new i15(this._privyInternal, d7);
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/funding/CoinbaseOnRampApi.mjs
var a19 = class {
  async initOnRampSession(r20) {
    return await this._privyInternal.fetch(n, { body: r20 });
  }
  async getStatus(t40) {
    return await this._privyInternal.fetch(a, { query: { partnerUserId: t40 } });
  }
  constructor(t40) {
    this._privyInternal = t40;
  }
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/funding/MoonpayOnRampApi.mjs
var import_fetch_retry2 = __toESM(require_fetch_retry_umd(), 1);

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/funding/moonpay.mjs
var o18 = { prod: { url: "https://api.moonpay.com/v1", key: "pk_live_hirbpu0cVcLHrjktC9l7fbc9ctjv0SL" }, sandbox: { url: "https://api.moonpay.com/v1", key: "pk_test_fqWjXZMSFwloh7orvJsRfjiUHXJqFzI" } };
var d5 = /* @__PURE__ */ new Set([t21.id, t16.id, e12.id, o6.id, a15.id, e14.id]);
var u3 = /* @__PURE__ */ new Set([t21.id, t16.id, t22.id, e12.id, o6.id, a15.id]);

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/funding/MoonpayOnRampApi.mjs
var i17 = class {
  async sign(t40) {
    return await this._privyInternal.fetch(o4, { body: t40 });
  }
  async getTransactionStatus({ transactionId: r20, useSandbox: i21 }) {
    let { url: n8, key: s11 } = o18[i21 ? "sandbox" : "prod"], e37 = await (0, import_fetch_retry2.default)(fetch, { retries: 3, retryDelay: 500 })(`${n8}/transactions/ext/${r20}?apiKey=${s11}`);
    if (!e37.ok) throw new o8({ error: `Failed to fetch transaction status for Transaction ${r20}`, code: "failed_to_fetch_moonpay_transaction_status", response: e37 });
    let c4 = await e37.json();
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/funding/FundingApi.mjs
var import_fetch_retry3 = __toESM(require_fetch_retry_umd(), 1);
var i18 = class {
  constructor(i21) {
    this.moonpay = new i17(i21), this.coinbase = new a19(i21);
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/mfa/MfaPasskeyApi.mjs
var r19 = class {
  async generateAuthenticationOptions(r20) {
    return await this._privyInternal.fetch(a3, { body: r20 });
  }
  constructor(t40) {
    this._privyInternal = t40;
  }
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/mfa/MfaSmsApi.mjs
var t39 = class {
  async sendCode(t40) {
    return await this._privyInternal.fetch(p4, { body: t40 });
  }
  constructor(r20) {
    this._privyInternal = r20;
  }
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/mfa/MfaApi.mjs
var i19 = class {
  setProxy(e37) {
    this.proxy = e37;
  }
  async getAccessTokenInternal() {
    let t40 = await this.privyInternal.getAccessTokenInternal();
    if (!t40) throw new e24({ error: "Missing access token", code: "attempted_rpc_call_before_logged_in" });
    return t40;
  }
  async verifyMfa() {
  ...
  async initEnrollMfa(t40) {
    if (!this.proxy) throw new e24({ error: "Embedded wallet proxy not initialized", code: "embedded_wallet_webview_not_loaded" });
    return await this.proxy.initEnrollMfa({ ...t40, accessToken: await this.getAccessTokenInternal() });
  }
  async submitEnrollMfa(t40) {
    if (!this.proxy) throw new e24({ error: "Embedded wallet proxy not initialized", code: "embedded_wallet_webview_not_loaded" });
    let r20 = await this.proxy.submitEnrollMfa({ ...t40, accessToken: await this.getAccessTokenInternal() });
    return await this.privyInternal.refreshSession(), r20;
  }
  async unenrollMfa(t40) {
    if (!this.proxy) throw new e24({ error: "Embedded wallet proxy not initialized", code: "embedded_wallet_webview_not_loaded" });
    let r20 = await this.proxy.unenrollMfa({ method: t40, accessToken: await this.getAccessTokenInternal() });
    return await this.privyInternal.refreshSession(), r20;
  }
  async clearMfa(t40) {
    if (!this.proxy) throw new e24({ error: "Embedded wallet proxy not initialized", code: "embedded_wallet_webview_not_loaded" });
    return await this.proxy.clearMfa(t40);
  }
  constructor(e37, i21) {
    this.proxy = i21, this.privyInternal = e37, this.sms = new t39(e37), this.passkey = new r19(e37);
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/recovery/RecoveryICloudApi.mjs
var e35 = class {
  async init(r20) {
    return this._privyInternal.fetch(o2, { body: { client_type: r20 } });
  }
  async getICloudConfiguration(t40) {
    return this._privyInternal.fetch(h3, { body: { client_type: t40 } });
  }
  constructor(t40) {
    this._privyInternal = t40;
  }
...
// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/recovery/RecoveryOAuthApi.mjs
var c3 = class {
  async generateURL(e37) {
    let r20 = i16(), c4 = c2(), _4 = await u2({ codeVerifier: r20, digest: this._crypto?.digest });
    return await Promise.all([this._storage.put(n7, r20), this._storage.put(t37, c4)]), this._privyInternal.fetch(a8, { body: { redirect_to: e37, code_challenge: _4, state_code: c4 } });
  }
  async authorize(t40, i21) {
    let [o19, a20] = await Promise.all([this._storage.get(n7), this._storage.get(t37)]);
    if (a20 !== i21) throw this._privyInternal.createAnalyticsEvent("possible_phishing_attempt", { flow: "recovery_oauth", storedStateCode: a20 ?? "", returnedStateCode: i21 ?? "" }), new e24({ code: "pkce_state_code_mismatch", error: "Unexpected auth flow. This may be a phishing attempt." });
    let c4 = await this._privyInternal.fetch(t9, { body: { authorization_code: t40, state_code: a20, code_verifier: o19 } });
    return await Promise.all([this._storage.del(n7), this._storage.del(t37)]), c4;
  }
  constructor(t40, e37, r20) {
    this._privyInternal = t40, this._storage = e37, this._crypto = r20;
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/recovery/RecoveryApi.mjs
var i20 = class {
  async getRecoveryKeyMaterial(t40, e37) {
    return this._privyInternal.fetch(e5, { body: { chain_type: e37 }, params: { address: t40 } });
  }
  constructor(r20, i21, o19) {
    this._privyInternal = r20, this.auth = new c3(this._privyInternal, i21, o19), this.icloudAuth = new e35(this._privyInternal);
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/client/Privy.mjs
...
var d6 = class {
  ...
  setMessagePoster(e37) {
    this.embeddedWallet.setMessagePoster(e37);
  }
  addOAuthTokensListener(e37) {
    return this._privyInternal.session.on("oauth_tokens_granted", e37), { unsubscribe: () => {
      this._privyInternal.session.removeListener("oauth_tokens_granted", e37);
    } };
  }
  setCallbacks(e37) {
    this._privyInternal.setCallbacks(e37);
  }
  getAccessToken() {
  ...
  getCompiledPath(e37, t40) {
    return this._privyInternal.getPath(e37, t40);
  }
  async fetchPrivyRoute(e37, t40) {
    return this._privyInternal.fetch(e37, t40);
  }
  get logger() {
    return this._privyInternal.logger;
  }
  constructor({ clientId: d7, ...h10 }) {
    this._privyInternal = new u({ ...h10, appClientId: d7 }), this.mfa = new i19(this._privyInternal), this.mfaPromises = new r13(), this.app = new r2(this._privyInternal), this.embeddedWallet = new y(this._privyInternal, h10.embeddedWalletMessagePoster, h10.supportedChains, this.mfa, this.mfaPromises, this.app), this.user = new t33(this._privyInternal), this.auth = new d4(this._privyInternal, this.embeddedWallet, h10.storage, h10.crypto, this.mfa), this.recovery = new i20(this._privyInternal, h10.storage, h10.crypto), this.funding = new i18(this._privyInternal), this.delegated = new t15(this._privyInternal), this.crossApp = new t14(this._privyInternal, h10.storage);
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/storage/LocalStorage.mjs
var e36 = class {
  async get(e37) {
    let t40 = localStorage.getItem(e37);
    return null === t40 ? void 0 : JSON.parse(t40);
  }
  put(e37, t40) {
    void 0 !== t40 ? localStorage.setItem(e37, JSON.stringify(t40)) : this.del(e37);
  }
  del(e37) {
    localStorage.removeItem(e37);
  }
  getKeys() {
    return Object.entries(localStorage).map((([e37]) => e37));
  }
};

// ../monorepo/platform/node_modules/@privy-io/js-sdk-core/dist/esm/index.mjs
