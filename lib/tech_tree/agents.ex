defmodule TechTree.Agents do
  ...
  defp fetch_value(attrs, "registry_address"), do: Map.get(attrs, "registry_address", Map.get(attrs, :registry_address))
  defp fetch_value(attrs, "token_id"), do: Map.get(attrs, "token_id", Map.get(attrs, :token_id))
  defp fetch_value(attrs, "wallet_address"), do: Map.get(attrs, "wallet_address", Map.get(attrs, :wallet_address))
