defmodule TechTree.TelemetryMetricsTest do
  ...
  test "exposes the expected runtime and request telemetry metrics" do
    ...
    expected_names = [
      ...
      "tech_tree.nodes.publish.stop.duration",
      "tech_tree.nodes.anchor.stop.duration",
      "tech_tree.nodes.failed_anchor.count",
      "tech_tree.nodes.stale_pinned.count",
      "tech_tree.oban.queue_depth.count",
      "tech_tree.launch.nodes.publish.duration_total",
      "tech_tree.launch.nodes.anchor.duration_total",
      "tech_tree.launch.nodes.transition.count",
      "tech_tree.launch.watches.fanout.watcher_broadcasts",
      "tech_tree.launch.watches.fanout.session_broadcasts",
      "tech_tree.launch.workers.fanout_watcher_notifications.duration",
      "tech_tree.launch.agent.siwa.deny.count",
      "vm.memory.total",
