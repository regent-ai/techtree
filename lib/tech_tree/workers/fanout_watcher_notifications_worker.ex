defmodule TechTree.Workers.FanoutWatcherNotificationsWorker do
  ...
  def perform(%Oban.Job{args: %{"node_id" => node_id}}) do
    ...
    :telemetry.execute(@worker_telemetry_event, %{duration: duration}, %{node_id: normalized_node_id})
    Logger.debug("fanout watcher worker completed node_id=#{normalized_node_id} duration=#{duration}")
