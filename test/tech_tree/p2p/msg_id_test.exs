defmodule TechTree.P2P.MsgIdTest do
  ...
  test "extracts transport_msg_id from valid json payloads" do
    payload = Jason.encode!(%{"transport_msg_id" => "chatbox:test:123", "body" => "hello"})

    assert MsgId.from_topic_and_data("regent.test.chatbox.global", payload) ==
             "chatbox:test:123"
  end

  test "falls back to a stable sha256 for invalid or missing ids" do
    topic = "regent.test.chatbox.global"
